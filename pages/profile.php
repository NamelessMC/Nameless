...
if(isset($profile)){
	...
	$longuuid = substr($profile_user[0]->uuid, 0, 8) . "-" . substr($profile_user[0]->uuid, 8, 4) . "-" . substr($profile_user[0]->uuid, 12, 4) . "-" . substr($profile_user[0]->uuid, 16, 4) . "-" . substr($profile_user[0]->uuid, 20, 12);
	// Is the user online?
      ...
      <div class="container">
               ...
               <br />
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-tabs" role="tablist">
					...
					<?php  ?>
					<li><a href="#infractions" role="tab" data-toggle="tab"><?php echo ucfirst($user_language['infractions']); ?></a></li>
					<?php  ?>
					<li><a href="#game_stats" role="tab" data-toggle="tab"><?php echo ucfirst($user_language['game_stats']); ?></a></li>
				  </ul>
                  <!-- Tab panes -->
		...
		if(!isset($_GET['type']) && !isset($_GET['id'])){
				...
				switch($inf_plugin){
					...
					break;
					case 'bm':
						$all_infractions = $infractions->bm_getAllInfractions($longuuid);
					break;
					case 'lb':
