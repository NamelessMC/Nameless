...
$language = [
    ...
    'cookie_popup' => 'Мы используем файлы cookie, чтобы обеспечить Вам наилучшую работу на нашем сайте.',
    'cookie_popup_disallow' => 'Отказаться от условий',
    'cookie_popup_allow' => 'Принять условия',
    'cookie_popup_more_info' => 'Узнать больше',
    'update_settings' => 'Показать виджет',
