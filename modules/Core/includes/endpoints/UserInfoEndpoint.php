    ...
    public function execute(Nameless2API $api) {
        if ($api->isValidated()) {
            ...
            foreach($custom_profile_fields->results() as $profile_field) {
                ...
                $user->profile_fields[$profile_field->id]['public'] = ($profile_field->public) ? true : false;
                $user->profile_fields[$profile_field->id]['required'] = ($profile_field->required) ? true : false;
