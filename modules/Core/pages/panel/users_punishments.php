								...
								foreach($groups as $group){
									...
									if($users->count()){
										...
										foreach($users as $item){
											// Send alert
											Alert::create($item->id, 'punishment', array('path' => 'core', 'file' => 'moderator', 'term' => 'user_punished_alert', 'replace' => array('{x}', '{y}'), 'replace_with' => array(Output::getClean($query->nickname), Output::getClean($user->data()->nickname))), array('path' => 'core', 'file' => 'moderator', 'term' => 'user_punished_alert', 'replace' => array('{x}', '{y}'), 'replace_with' => array(Output::getClean($query->nickname), Output::getClean($user->data()->nickname))), URL::build('/panel/users/punishments/', 'user=' . Output::getClean($query->id)));
										}
									}
								}
							}
