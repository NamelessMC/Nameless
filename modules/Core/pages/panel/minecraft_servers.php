                    ...
                    if (Token::check()) {
                        ...
                        if ($validation->passed()) {
                            ...
                            try {
                                ...
                                } else if (empty($_POST['server_port'])) {
                                    $port = null;
                                } else {
                                    $port = 25565;
                                }
        ...
        case 'order':
            ...
            try {
                if (isset($_POST['servers']) && Token::check($_POST['token'])) {
                    $servers = json_decode($_POST['servers'], true)->servers;
            ...
            if (Token::check()) {
                ...
                try {
                    ...
                    if ($new_default > 0) {
                        ...
                        if (count($current_default) && $current_default[0]->id !== (string)$new_default) {
                    ...
                    $cache->setCacheName('query_cache');
