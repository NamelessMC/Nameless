...
$language = [
    ...
    'discord_invite_info' => 'Para convidar o bot Nameless Link para seu servidor Discord, clique <a target="_blank" href="https://namelessmc.com/discord-bot-invite">aqui</a>. Então, envie uma mensagem privada para o bot com o comando <code>/apiurl</code> para vincular o bot ao seu site. Alternativamente, você pode <a target="_blank" href="https://github.com/NamelessMC/Nameless-Link/wiki/Own-instance">hospedar o bot você mesmo</a>.',
