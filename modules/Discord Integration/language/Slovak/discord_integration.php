...
$language = [
    ...
    'discord_invite_info' => 'Ak chcete pozvať Nameless Link bota na svoj Discord server, kliknite <a target="_blank" href="https://namelessmc.com/discord-bot-invite">sem</a>. Potom spustite príkaz <code>/apiurl</code> na prepojenie bota s vašou webstránkou. Prípadne môžete <a target="_blank" href="https://docs.namelessmc.com/link/2.0/installation">hostiť robota sami</a>.',
    'discord_bot_must_be_setup' => 'Discord integráciu nie je možné povoliť, kým nenastavíte bota. Pre informáciu prosím <a href="https://docs.namelessmc.com/link/2.0/setup" target="_blank">kliknite tu</a>.',
