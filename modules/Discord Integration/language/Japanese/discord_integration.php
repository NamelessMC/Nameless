...
$language = [
    ...
    'discord_invite_info' => 'Nameless LinkボットをDiscordサーバーに招待するには、<a target="_blank" href="https://namelessmc.com/discord-bot-invite">ここ</a>をクリックしてください。次に、<code>/apiurl</code>コマンドを実行して、ボットをあなたのウェブサイトにリンクさせます。また、<a target="_blank" href="https://docs.namelessmc.com/link/2.0/installation">自分でボットをホストすることもできます</a>。',
    'discord_bot_must_be_setup' => 'ボットを設定するまでは、Discord統合を有効にすることはできません。詳細については、<a href="https://docs.namelessmc.com/link/2.0/setup" target="_blank">ここをクリック</a>してください。',
