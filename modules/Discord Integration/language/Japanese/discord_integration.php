...
$language = [
    ...
    'discord_invite_info' => 'Nameless LinkボットをDiscordサーバーに招待するには、{{inviteLinkStart}}ここ{{inviteLinkEnd}} をクリックしてください。次に、<code>/apiurl</code>コマンドを実行して、ボットをあなたのウェブサイトにリンクさせます。また、{{selfHostLinkStart}}自分でボットをホストすることもできます{{selfHostLinkEnd}}。',
    'discord_bot_must_be_setup' => 'ボットを設定するまでは、Discord統合を有効にすることはできません。詳細については、{{linkStart}}ここをクリック{{linkEnd}} してください。',
    ...
    'discord_id_confirm' => 'Discordで「 "/verify {{token}}" {トークン}」というコマンドを実行して、Discordアカウントのリンクを完了させてください。',
    'pending_link' => '保留中',
