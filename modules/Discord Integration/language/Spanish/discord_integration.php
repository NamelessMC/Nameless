...
$language = [
    ...
    'discord_invite_info' => 'Para invitar al bot Nameless Link a tu servidor Discord, haz clic en <a target="_blank" href="https://namelessmc.com/discord-bot-invite">aquí</a>. A continuación, ejecuta el comando <code>/apiurl</code> para enlazar el bot con tu sitio web. También puedes <a target="_blank" href="https://docs.namelessmc.com/link/2.0/installation">alojar el bot tú mismo</a>.',
    'discord_bot_must_be_setup' => 'No se puede habilitar la integración de Discord hasta que no se haya configurado el bot. Para obtener información, por favor <a href="https://docs.namelessmc.com/link/2.0/setup" target="_blank">haga clic aquí</a>.',
