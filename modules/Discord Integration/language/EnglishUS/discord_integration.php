...
$language = [
    ...
    'discord_invite_info' => 'To invite the Nameless Link bot to your Discord server, click {{inviteLinkStart}}here{{inviteLinkEnd}}. Then, run the <code>/apiurl</code> command to link the bot with your website. Alternatively, you can {{selfHostLinkStart}}host the bot yourself{{selfHostLinkEnd}}.',
    'discord_bot_must_be_setup' => 'Cannot enable Discord Integration until you have set up the bot. For information, please {{linkStart}}click here{{linkEnd}}.',
