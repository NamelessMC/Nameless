...
$language = [
    ...
    'discord_invite_info' => 'Чтобы пригласить бота Nameless Link на ваш Discord сервер, нажмите <a target="_blank" href="https://namelessmc.com/discord-bot-invite">сюда</a>. Затем, следуйте инструкции которую вы получите после подключения бота. Как вариант, вы можете разместить <a target="_blank" href="https://docs.namelessmc.com/link/2.0/installation">свою версию бота</a>.',
    'discord_bot_must_be_setup' => 'Нельзя интегрировать сайт, пока вы не подключите бота. Информация <a href="https://docs.namelessmc.com/link/2.0/setup" target="_blank">здесь</a>.',
