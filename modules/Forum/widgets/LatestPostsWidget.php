        ...
        if ($this->_cache->isCached('discussions')) {
            ...
            while ($n < $limit) {
                ...
                $template_array[] = [
                    ...
                    'topic_created_rough' => $timeago->inWords(date(DATE_FORMAT, $discussions[$n]['topic_date']), $this->_language->getTimeLanguage()),
                    ...
                    'last_reply_rough' => $timeago->inWords(date(DATE_FORMAT, $discussions[$n]['topic_reply_date']), $this->_language->getTimeLanguage()),
