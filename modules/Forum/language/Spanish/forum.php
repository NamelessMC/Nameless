...
$language = [
    ...
    'views' => 'vistas',
    'posts' => 'publicaciones',
    'x_posts' => '{{count}} publicaciones',
    'x_topics' => '{{count}} temas',
    'registered_x' => 'Registrado el: {{registeredAt}}',
    'by' => 'por',
    'in' => 'en',
    ...
    'user_tag_info' => 'Has sido etiquetado en una publicación por {{author}}.',
    'creating_topic_in_x' => 'Creando un tema en {{forum}}',
    ...
    'spam_wait' => 'Porfavor, espera {{count}} segundos antes de postear.',
    'overview' => 'Vista General',
    'no_label' => 'Sin Etiqueta',
    'forum_redirect_warning' => 'Alerta: Estás a punto de dejar este sitio. ¿Estás seguro de que deseas proceder ir a {{url}}?',
    'follow' => 'Seguir',
    ...
    'search_again_in_x_seconds' => 'Por favor, espera {{count}} segundos antes de volver a buscar.',
