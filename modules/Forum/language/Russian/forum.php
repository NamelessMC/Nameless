...
$language = [
    ...
    'users_registered' => '<strong>Всего игроков:</strong> {x}',
    'latest_member' => '<strong>Посл. регистр.:</strong> {x}',
    'subforums' => 'Подфорумы',
    'subforum' => 'Подфорум',
    ...
    'creating_topic_in_x' => 'Создание топика в {x}',
    ...
    'last_edited' => 'Последнее редактирование: {x}',
    'quote' => 'Цитировать',
