...
$language = [
    ...
    'views' => 'просмотры',
    'posts' => 'посты',
    'x_posts' => '{{count}} постов',
    'x_topics' => '{{count}} топиков',
    ...
    'creating_topic_in_x' => 'Создание топика в {{forum}}',
    ...
    'last_edited' => 'Последнее редактирование: {{lastEditedAt}}',
    'quote' => 'Цитировать',
    ...
    'spam_wait' => 'Пожалуйста, подождите {{count}} секунд, прежде чем отправлять снова.',
    'overview' => 'Обзор',
    'no_label' => 'Нет метки',
    'forum_redirect_warning' => 'Внимание: вы собираетесь покинуть этот сайт! Вы уверены, что хотите перейти на {{url}}?',
    'follow' => 'Подписаться',
    'unfollow' => 'Отписаться',
    ...
    'started_by_x' => 'Автор топика: {{author}}',
    ...
    'parent_forum_x' => 'Родительский форум: {{forum}}',
    ...
    'search_again_in_x_seconds' => 'Пожалуйста, подождите {{count}} секунд прежде чем снова искать.',
