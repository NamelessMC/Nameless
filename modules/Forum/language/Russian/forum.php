...
$language = [
    ...
    'users_registered' => '<strong>Всего игроков:</strong> {x}', // Don't replace "{x}"
    'latest_member' => '<strong>Посл. регистр.:</strong> {x}', // Don't replace "{x}"
    'subforums' => 'Подфорумы',
    'subforum' => 'Подфорум',
    ...
    'error_rating_post' => 'Извините, произошла ошибка при оценки сообщения.',
    'topic_stuck' => 'Топик закреплён.',
    'topic_unstuck' => 'Топик откреплён.',
    'spam_wait' => 'Пожалуйста, подождите {x} секунд, прежде чем отправлять снова.',
    'overview' => 'Обзор',
    'no_label' => 'Нет метки',
    'forum_redirect_warning' => 'Внимание: вы собираетесь покинуть этот сайт! Вы уверены, что хотите перейти на {x}?',
    'follow' => 'Подписаться',
    'unfollow' => 'Отписаться',
    ...
    'label' => 'Метка',
    'label_forums' => 'Форумы для метки',
    'label_groups' => 'Группы, использующие метку',
    'no_forums' => 'Нет форумов',
    'no_labels_defined' => 'Метки ещё не созданы.',
    'no_label_types_defined' => 'Типы меток ещё не созданы.',
    'label_edit_success' => 'Метка успешно отредактирована.',
    'label_type_edit_success' => 'Тип метки успешно отредактирован.',
    ...
    'can_edit_topic' => 'Может редактировать свои топики?',
    ...
    'forum_layout' => 'Стиль форума',
    'table_view' => 'Вид таблицы',
    'latest_discussions_view' => 'Последние обсуждения',
    'input_forum_title' => 'Пожалуйста, введите название форума.',
    'input_forum_description' => 'Пожалуйста, введите описание форума.',
    'forum_name_minimum' => 'Название форума должно состоять не менее чем из 2 символов.',
    'forum_description_minimum' => 'Описание форума должно состоять не менее чем из 2 символов.',
    'forum_name_maximum' => 'Название форума должно содержать не более 150 символов.',
    'forum_description_maximum' => 'Описание форума должно содержать не более 255 символов.',
    ...
    'invalid_redirect_url' => 'Вы включили перенаправление форума, но не ввели допустимый URL-адрес длиной от 1 до 512 символов.',
    'forum_icon' => 'Иконка форума',
    'forum_icon_maximum' => 'Иконка форума не должна содержать более чем 256 симвлдлв.',
    ...
    'topic_placeholder' => 'Плейсхолдер топика',
    'default_labels' => 'Стандартные метки',
    'default_labels_info' => 'Они будут назначаться новой теме на форуме, если их не снимут во время создания темы. Ctrl+Click для выделения нескольких вариантов',
    ...
    'following_topics' => 'Отслеживаемые темы',
    'unfollow_all_topics' => 'Перестать следить за темами',
    'confirm_unfollow_all_topics' => 'Вы не хотите отслеживать изменения в выбранных темах?',
    'all_topics_unfollowed' => 'Отслеживание тем прекращено.',
    'not_following_any_topics' => 'Вы не отслеживаете темы.',
