...
$language = [
    ...
    'views' => 'Visualizações',
    'posts' => 'Postagens',
    'x_posts' => '{{count}} postagens',
    'x_topics' => '{{count}} tópicos',
    'registered_x' => 'Entrou: {{registeredAt}}',
    'by' => 'por',
    'in' => 'em',
    ...
    'creating_topic_in_x' => 'Criando tópico em {{forum}}',
    ...
    'last_edited' => 'Última edição: {{lastEditedAt}}',
    'quote' => 'Citar',
    ...
    'spam_wait' => 'Aguarde {{count}} segundos antes de postar novamente.',
    'overview' => 'Visão geral',
    'no_label' => 'Nenhum rótulo',
    'forum_redirect_warning' => 'Aviso: você está prestes a sair deste site! Tem certeza de que deseja prosseguir para {{url}}?',
    'follow' => 'Seguir',
    ...
    'parent_forum_x' => 'Fórum referência: {{forum}}',
    ...
    'search_again_in_x_seconds' => 'Por favor, aguarde {{count}} segundos para pesquisar novamente.',
