...
$language = [
    ...
    'users_registered' => '<strong>Utilizatori înregistrați:</strong> {x}',
    'latest_member' => '<strong>Ultimul membru:</strong> {x}',
    ...
    'creating_topic_in_x' => 'Creați un subiect în {x}',
