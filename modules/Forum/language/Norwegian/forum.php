...
$language = [
    ...
    'users_registered' => '<strong>Brukere registrert:</strong> {x}',
    'latest_member' => '<strong>Siste medlem:</strong> {x}',
    ...
    'creating_topic_in_x' => 'Lager tråd i {x}',
    'topic_title' => 'Tittel',
    'new_reply' => 'Nytt svar',
    're' => 'Svar: ',
