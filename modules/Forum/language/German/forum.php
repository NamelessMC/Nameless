...
$language = array(
    ...
    'users_registered' => '<strong>Benutzer registriert:</strong> {x}', // Don't replace "{x}"
    'latest_member' => '<strong>Neuester Benutzer:</strong> {x}', // Don't replace "{x}"
    'subforums' => 'Unterforen',
    'subforum' => 'Unterforum',
    'no_topics' => 'Es wurden noch keine Themen erstellt.',
    'no_topics_short' => 'Keine Themen',
    ...
    're' => 'RE: ',
    'topic_locked' => 'Thema geschlossen.',
    'mod_actions' => 'Moderation',
    'lock_topic' => 'Thema schließen',
    'unlock_topic' => 'Thema Öffnen',
    'merge_topic' => 'Thema zusammenfassen',
    'merge_topics' => 'Themen zusammenfassen',
    'merge_instructions' => 'Der Thread zum Zusammenführen <strong>muss</strong> im selben Forum sein. Verschieben Sie gegebenenfalls einen Thread.',
    'confirm_delete_short' => 'Löschen bestätigen',
    'confirm_delete_topic' => 'Bist du sicher, dass du dieses Thema löschen willst?',
    ...
    'move_topic_to' => 'Thema verschieben nach:',
    'stick_topic' => 'Thema anheften',
    'unstick_topic' => 'Thema abheften',
    'share' => 'Teilen',
    ...
    'content_required' => 'Gib bitte Inhalt an',
    'title_min_2' => 'Dein Titel muss mindestens 2 Zeichen lang sein.',
    'title_max_64' => 'Dein Titel darf nicht länger als 64 Zeichen sein.',
    'content_min_2' => 'Dein Inhalt muss mindestens 2 Zeichen beihnalten.',
    'content_max_50000' => 'Dein Inhalt darf nicht länger als 50000 Zeichen lang sein.',
    ...
    'label_type_creation_success' => 'Label-Typ erfolgreich erstellt.',
    'label_creation_error' => 'Fehler beim erstellen des Labels',
    'label_type_creation_error' => 'Fehler beim erstellen des Label-Typ.',
    'creating_forum' => 'Erstelle neues Forum',
    'forum_name' => 'Forum Name',
    'forum_description' => 'Forum Beschreibung',
    'delete_forum' => 'Forum löschen',
    'move_topics_and_posts_to' => 'Verschiebe Themen und Beiträge zu',
    ...
    'forum_created_successfully' => 'Forum wurde erfolgreich erstellt.',
    'forum_layout' => 'Forum Layout',
    'table_view' => 'Tabellenansicht',
    'latest_discussions_view' => '"Letzte Diskussionen" Ansicht',
    'input_forum_title' => 'Gib einen Forennamen ein.',
    'input_forum_description' => 'Gib eine Forenbeschreibung ein.',
    'forum_name_minimum' => 'Der Forenname muss mindestens 2 Zeichen lang sein.',
    'forum_description_minimum' => 'Die Forenbeschreibung muss mindestens 2 Zeichen lang sein.',
    'forum_name_maximum' => 'Der Forenname darf maximal 150 Zeichen lang sein.',
    'forum_description_maximum' => 'Die Forenbeschreibung darf maximal 255 Zeichen lang sein.',
