...
$language = [
    ...
    'users_registered' => '<strong>Benutzer registriert:</strong> {x}',
    'latest_member' => '<strong>Neuester Benutzer:</strong> {x}',
    ...
    'creating_topic_in_x' => 'Erstelle Thema in {x}',
