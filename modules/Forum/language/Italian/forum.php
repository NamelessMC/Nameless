...
$language = [
    ...
    'posts' => 'post',
    'x_posts' => '{{count}} post',
    'x_topics' => '{{count}} discussioni',
    'registered_x' => 'Iscritto: {{registeredAt}}',
    'by' => 'da',
    'in' => 'nel',
    ...
    'creating_topic_in_x' => 'Creazione della discussione in {{forum}}',
    ...
    'last_edited' => 'Ultima modifica: {{lastEditedAt}}',
    'quote' => 'Quota',
    ...
    'spam_wait' => 'Attendi {{count}} secondi prima di postare di nuovo.',
    'overview' => 'Panoramica',
    'no_label' => 'Senza etichetta',
    'forum_redirect_warning' => 'Avviso: stai per uscire da questo sito! Sei sicuro di voler procedere verso {{url}}?',
    'follow' => 'Segui',
    ...
    'started_by_x' => 'Avviato da {{author}}',
    ...
    'parent_forum_x' => 'Forum principale: {{forum}}',
    ...
    'search_again_in_x_seconds' => 'Attendi {{count}} secondi prima di effettuare nuovamente la ricerca.',
