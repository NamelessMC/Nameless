...
$language = [
    ...
    'users_registered' => '<strong>Utenti Registrati:</strong> {x}',
    'latest_member' => '<strong>Ultimo Membro:</strong> {x}',
    ...
    'creating_topic_in_x' => 'Creazione della discussione in {x}',
