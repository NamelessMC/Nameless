...
$language = [
    ...
    'users_registered' => '<strong>Users Registered:</strong> {x}',
    'latest_member' => '<strong>Latest Member:</strong> {x}',
    'subforums' => 'Subforums',
    'subforum' => 'Subforum',
    ...
    'creating_topic_in_x' => 'Creating topic in {x}',
