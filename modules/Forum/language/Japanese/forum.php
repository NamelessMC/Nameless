...
$language = [
    ...
    'creating_topic_in_x' => '{{forum}} でトピックを作成',
    ...
    'edit' => '編集',
    'edit_post' => '投稿の編集',
    'last_edited' => '最後の編集: {{lastEditedAt}}',
    'quote' => '引用',
    ...
    'spam_wait' => '再投稿する前に {{count}} 秒待ってください。',
    'overview' => '概要',
    'no_label' => '<span class="badge badge-secondary">ラベルなし</span>',
    'forum_redirect_warning' => '注意：あなたはこのサイトを離れようとしています！{{url}} に進んでよろしいですか？',
    'follow' => 'フォロー',
    'unfollow' => 'フォロー解除',
    ...
    'started_by_x' => '{{author}} によって開始されました',
    ...
    'search_again_in_x_seconds' => '{{count}} 秒待ってから再度検索してください。',
    'search_results' => '検索結果',
    'new_search' => '新しい検索',
