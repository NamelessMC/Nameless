...
$language = [
    ...
    'users_registered' => '<strong>Utlisateurs enregistrées :</strong> {x}',
    'latest_member' => '<strong>Dernier membre :</strong> {x}',
    ...
    'creating_topic_in_x' => 'Création du sujet dans {x}',
    ...
    'last_edited' => 'Dernière modification : {x}',
    'quote' => 'Citation',
