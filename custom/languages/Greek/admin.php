...
$language = [
    ...
    'default_template_set' => 'Προεπιλεγμένο template οριστεί σε {x} επιτυχώς.',
    ...
    'confirm_user_deletion' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε το χρήστη <strong>{x}</strong>?',
    ...
    'confirm_group_deletion' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε την ομάδα {x}?',
    ...
    'can_view_staffcp' => 'Μπορεί η ομάδα να δεί το StaffCP?',
    'user' => 'User',
