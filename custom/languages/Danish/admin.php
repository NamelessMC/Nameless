...
$language = [
    ...
    'send_test_email_info' => 'Følgende knap vil forsøge at sende en e-mail til din e-mailadresse, <strong>{x}</strong>. Eventuelle fejl smidt mens du sender e-mailen vil blive vist.',
    'send' => 'Send',
    ...
    'default_template_set' => 'Default template set to {x} successfully.',
    'template_deactivated' => 'Template deactivated.',
    'template_activated' => 'Template activated.',
    'permissions' => 'Permissions',
    'setting_perms_for_x' => 'Setting permissions for template {x}',
    ...
    'background_image_x' => 'Background image: <strong>{x}</strong>',
    ...
    'views_x' => 'Visninger: {x}',
    'rating_x' => 'Bedømmelse: {{rating}}',
    'editing_template_x' => 'Editing template {x}',
    'editing_template_file_in_template' => 'Editing file {x} in template {y}',
    ...
    'confirm_user_deletion' => 'Are you sure you want to delete the user <strong>{x}</strong>?',
    ...
    'confirm_group_deletion' => 'Are you sure you want to delete the group {x}?',
    ...
    'editing_user_x' => 'Redigerer bruger {x}',
    'details' => 'Detaljer',
    ...
    // Updates
    'update' => 'Update',
    'current_version_x' => 'Current version: <strong>{x}</strong>',
    'new_version_x' => 'New version: <strong>{x}</strong>',
    ...
    'link_to_complete_registration' => 'Link to complete registration: {x}',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Unable to load sitemap file {x}',
    ...
    'sitemap_last_generated_x' => 'The sitemap was last generated {x}',

    // Page metadata
    'page_metadata' => 'Page Metadata',
    'metadata_page_x' => 'Viewing metadata for page {x}',
    'keywords' => 'Keywords',
