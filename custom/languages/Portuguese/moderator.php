...
$language = [
    ...
    'no_ips_with_username' => 'Nenhum endereço IP para esse usuário encontrado.',
    'no_accounts_with_that_ip' => 'Nenhuma conta para esse endereço IP encontrado.',
    '1_account_with_ip' => 'Encontrado 1 conta com o IP {y}', // Não substituir {y}.
    'count_accounts_with_ip' => 'Encontrados {x} contas com o endereço de IP {y}', // Não substituir o {x} ou {y}.
    '1_ip_with_name' => 'Encontrado 1 IP para o usuário {y}', // Não substituir {y}.
    'count_ips_with_name' => 'Encontrados {x} endereços de IP para o usuário {y}', // Não substituir o {x} ou {y}.
    'no_users_or_ips_found' => 'Não foram encontrados usuários ou endereços IP.',

    // Reports
    'reports' => 'Denúncias',
    'report_alert' => 'Nova denúncia enviada.',
    'user_reported' => 'Usuário Denúnciado',
    'comments' => 'Comentários',
    'updated_by' => 'Atualizado Por',
    'actions' => 'Ações',
    'view_closed' => 'Visualizar Fechado',
    'view_open' => 'Visualizar Aberto',
    'viewing_report' => 'Visualizando Denúncia',
    'view_content' => 'Visualizar conteúdo denunciado',
    'no_comments' => 'Sem comentários',
    'new_comment' => 'Novo comentário',
    'report_comment_invalid' => 'Conteúdo do comentário inválido. Certifique-se de que introduziu um comentário entre 1 e 10000 caracteres.',
    'close_report' => 'Fechar denúncia',
    'reopen_report' => 'Reabrir denúncia',
    '1_open_report' => 'Atualmente, há <strong>1</strong> denúncia aberta.',
    'open_reports' => 'Atualmente, há <strong>{x}</strong> denúncias abertas.', // Não substituir {x}.
    'no_open_reports' => 'Atualmente não há denúncias abertas.',
    'no_closed_reports' => 'Atualmente não há denúncias fechadas.',
    'recent_reports' => 'Denúncias Recentes',
    'reported_by' => 'Denunciado por:',
    'website' => 'Website',
    'ingame' => 'Ingame',
    'x_closed_report' => '{x} fechar essa denúncia.', // Não substituir o {x} (nome de usuário).
    'x_reopened_report' => '{x} reabrir essa denúncia.', // Não substituir o {x} (nome de usuário).
    ...
    'warn' => 'Advertir',
    'ban_ip' => 'Banir por IP',
    'viewing_user_x' => 'Analisando o usuário {x}', // Não substituir {x}.
    ...
    'user_punished_alert' => '{x} puniu o usuário {y}', // Não substituir o {x} (membro da equipe) ou {y} (usuário punido).
    'revoke' => 'Anular',
    'revoked' => 'Anulado',
    ...
    'punishment_revoked_alert' => '{x} anulou a punição do usuário {y}', // Não substituir o {x} (membro da equipe) ou {y} (usuário com punição revogada).
