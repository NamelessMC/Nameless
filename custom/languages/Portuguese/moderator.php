...
$language = [
    ...
    '1_account_with_ip' => 'Encontrado 1 conta com o IP {{address}}',
    'count_accounts_with_ip' => 'Encontrados {{count}} contas com o endereço de IP {{address}}',
    '1_ip_with_name' => 'Encontrado 1 IP para o usuário {{user}}',
    'count_ips_with_name' => 'Encontrados {{count}} endereços de IP para o usuário {{user}}',
    ...
    'open_reports' => 'Atualmente, há {{count}} denúncias abertas.',
    ...
    'user_punished_alert' => '{{staffUser}} puniu o usuário {{user}}',
    'revoke' => 'Anular',
    'revoked' => 'Anulado',
