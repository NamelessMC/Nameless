...
$language = array(
    ...
    '1_account_with_ip' => 'Encontrado 1 conta com o IP {y}', // Don't replace "{y}"
    'count_accounts_with_ip' => 'Encontrados {x} contas com o endereço de IP {y}', // Don't replace "{x}" or "{y}"
    ...
    'open_reports' => 'Atualmente, há <strong>{x}</strong> denúncias abertas.', // Don't replace {x}
    ...
    'website' => 'Website',
    'ingame' => 'Ingame',
    'x_closed_report' => '{x} fechar essa denúncia.', // Don't replace {x} (username)
