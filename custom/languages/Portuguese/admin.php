...
$language = [
    ...
    'send_test_email_info' => 'O seguinte botão irá tentar enviar um email para o seu endereço de email, {{email}}. Qualquer erro que occora enquanto envia o email será exibido.', // Não substituir o {x}.
    'send' => 'Enviar',
    ...
    'unable_to_enable_module_dependencies' => 'Não foi possível habilitar o módulo, pois depende do módulo {{module}}, que não está habilitado.', // Não substituir o {x}.
    'unable_to_disable_module' => 'Não foi possível desativar o módulo - o módulo {{module}} depende disso.', // Não substituir o {x}.
    ...
    'confirm_user_deletion' => 'Você tem certeza que deseja excluir o usuário {{user}}?', // Não substituir o {x}.
    ...
    'confirm_group_deletion' => 'Você tem certeza de que deseja excluir o grupo {{group}}?', // Não substituir o {x}.
    ...
    'sitemap_last_generated_x' => 'Último mapa do site gerado {{generatedAt}}', // Não substituir o {x}.
