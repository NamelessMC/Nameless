...
$language = [
    ...
    'mailer_settings_info' => 'Os campos a seguir são necessários se você tiver habilitado o PHPMailer. Para obter mais informações sobre como preencher esses campos, confira <a href="https://docs.namelessmc.com/setup/2.0/smtp" target="_blank">a wiki</a>.',
    'host' => 'Host',
    'email_port' => 'Porta',
    ...
    'api_endpoints_info' => 'A API Endpoints permitem que os Módulos criem maneiras para aplicativos externos (como Minecraft e Discord) interagirem com o seu site NamelessMC. <a href="https://docs.namelessmc.com/development/2.0/api" target="_blank">Check out the API documentation here</a>',
    'route' => 'Rota',
