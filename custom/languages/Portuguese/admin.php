...
$language = [
    ...
    // Overview
    'running_nameless_version' => 'Versão do NamelessMC: {{version}}',
    'running_php_version' => 'Versão do PHP: {{version}}',
    ...
    'send_test_email_info' => 'O seguinte botão irá tentar enviar um email para o seu endereço de email, {{email}}. Qualquer erro que occora enquanto envia o email será exibido.',
    'send' => 'Enviar',
    ...
    'server_id_x' => 'ID do Servidor: {{serverId}}',
    ...
    'module_outdated' => 'Detectamos que este módulo é destinado à versão {{intendedVersion}} do Nameless, mas você está rodando a versão {{actualVersion}}',
    ...
    'unable_to_enable_module_dependencies' => 'Não foi possível habilitar o módulo, pois depende do módulo {{module}}, que não está habilitado.',
    'unable_to_disable_module' => 'Não foi possível desativar o módulo - o módulo {{module}} depende disso.',

    // Styles
    'templates' => 'Modelos',
    'panel_templates' => 'Painel de Modelos',
    'view_all_panel_templates' => 'Ver todos os modelos de painel',
    'template_outdated' => 'Você está utilizando um modelo para a versão {{intendedVersion}} do Nameless, porém sua versão do Nameless é {{actualVersion}}',
    ...
    'default_template_set' => 'Modelo padrão definido para {{template}} com sucesso.',
    ...
    'background_image_x' => 'Imagem de fundo: {{imageName}}',
    'banner_image_x' => 'Imagem do banner: {{imageName}}',
    'logo_image_x' => 'Imagem do logotipo: {{imageName}}',
    'favicon_image_x' => 'Imagem da Favicon: {{imageName}}',
    'x_directory_not_writable' => 'O diretório {{directory}} não é gravável!',
    ...
    'confirm_user_deletion' => 'Você tem certeza que deseja excluir o usuário {{user}}?',
    ...
    'confirm_group_deletion' => 'Você tem certeza de que deseja excluir o grupo {{group}}?',
    ...
    'editing_user_x' => 'Editando usuário {{user}}',
    'details' => 'Detalhes',
    ...
    // Updates
    'update' => 'Atualizar',
    'current_version_x' => 'Versão atual: {{version}}',
    'new_version_x' => 'Nova versão: {{version}}',
    ...
    'editing_widget_x' => 'Editando o widget {{widget}}',
    'module_x' => 'Módulo: {{module}x}',
    ...
    'editing_page_x' => 'Editando a Página {{page}}',
    ...
    'sitemap_last_generated_x' => 'Último mapa do site gerado {{generatedAt}}',
