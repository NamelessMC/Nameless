...
$language = [
    ...
    // Profile settings
    'field_is_required' => '{{field}} é requerido.',
    ...
    'i_agree' => 'Eu aceito',
    'agree_t_and_c' => 'Eu li e aceito os {{linkStart}}Termos & Condições{{linkEnd}}.',
    ...
    'post_on_wall' => 'Publicações no perfil de {{user}}',
    'invalid_wall_post' => 'Certifique-se de que a sua mensagem tem entre 1 e 10000 caracteres.',
    '1_reaction' => '1 reação',
    'x_reactions' => '{{count}} reações',
    '1_like' => '1 curtida',
    'x_likes' => '{{count}} curtidas',
    '1_reply' => '1 resposta',
    'x_replies' => '{{count}} respostas',
    ...
    'registered_x' => 'Cadastrado: {{registeredAt}}',
    'last_seen' => 'Visto pela última vez:',
    'last_seen_x' => 'Visto pela última vez: {{lastSeenAt}}',
    'new_wall_post' => '{{author}} postou no seu perfil.',
    ...
    'new_wall_post_reply' => '{{author}} respondeu a sua postagem no perfil de {{user}}.',
    'new_wall_post_reply_your_profile' => '{{author}} respondeu ao seu post no seu perfil.',
