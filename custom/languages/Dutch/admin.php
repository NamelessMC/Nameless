...
$language = array(
	...
	'server_address_help' => 'Dit is het IP adres of domein dat wordt gebruikt om met de server te verbinden. Als het nodig is, kan je de server poort hier ook toevoegen.',
