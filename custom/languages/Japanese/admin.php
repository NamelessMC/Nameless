...
$language = [
    ...
    'background_image_x' => '背景画像:<strong>{x}</strong>',
    'banner_image_x' => 'バナー画像:<strong>{x}</strong>',
    'logo_image_x' => 'ロゴ画像:<strong>{x}</strong>',
    'favicon_image_x' => 'ファビコン画像:<strong>{x}</strong>',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'サイトマップファイル{x}を読み込むことができませんでした。',
    ...
    'unlink_account_success' => '{x}からアカウントの連携を解除することに成功しました。',
];
