...
$language = array(
    ...
    'google_recaptcha_login' => 'ログイン時にGoogleのreCAPTCHAを有効にしますか？',
    ...
    'authme_db_password_hidden' => 'AuthMe データベースのパスワードは、セキュリティ上の理由から非表示になっています。',
    ...
    'background_directory_not_writable' => '<strong>uploads/backgrounds</strong> ディレクトリは書き込み可能ではありません！',
    'template_banners_directory_not_writable' => '<strong>uploads/template_banners</strong> ディレクトリは書き込み可能ではありません！',
    ...
    'hook_select_info' => 'イベントとして \'New topic\' が選択されているフックのみが表示されます。',
    'hook_url' => 'ウェブフックURL',
    'hook_type' => 'ウェブフックの種類',
