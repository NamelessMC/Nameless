...
$language = [
    ...
    'send_test_email_info' => '<strong>{x}</strong>にNamelessMCからテストメールを送信します。テストを実行することで、メール設定が正しくされているかを確認できます。テスト終了後確認されたエラーは表示されます。送信するには「送信」を押してください。',
    'send' => '送信',
    ...
    'unable_to_enable_module_dependencies' => 'モジュール{x}に依存しているため、モジュールを有効にすることができませんでした。',
    'unable_to_disable_module' => 'モジュールを無効にすることができませんモジュール{x}はそれに依存しています。',
    ...
    'default_template_set' => '{x}をデフォルトのテンプレートに設定しました。',
    'template_deactivated' => 'テンプレートが無効になりました。',
    'template_activated' => 'テンプレートが有効になりました。',
    'permissions' => '権限',
    'setting_perms_for_x' => 'テンプレート{x}のアクセス許可を設定する。',
    ...
    'editing_template_file_in_template' => 'テンプレート{y}内のファイル{x}を編集',
    ...
    'confirm_user_deletion' => '<strong>{x}</strong>を削除してもよろしいですか？',
    ...
    'delete_group' => 'グループ削除',
    'confirm_group_deletion' => 'グループ{x}を削除してもよろしいですか？',
    ...
    'link_to_complete_registration' => '登録を完了するためのリンク: {x}',
    ...
    'sitemap_last_generated_x' => '最終サイトマップ生成:{x}',
