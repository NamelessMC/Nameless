...
$language = [
    ...
    'navbar_icon_instructions' => 'ナビゲーションバーアイコンは<a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" rel="noopener nofollow">Font Awesome</a>, <a href="https://fomantic-ui.com/elements/icon.html" target="_blank" rel="noopener nofollow">Fomantic UI</a>を参照して使用したいアイコンのHTMLソースを貼り付けてください。',
    ...
    'server_id_x' => 'サーバーID: {x}', // Don't replace {x}
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'サイトマップファイル{x}を読み込むことができませんでした。', // Don't replace {x}
    ...
    'sitemap_last_generated_x' => '最終サイトマップ生成:{x}', // Don't replace {x}

    // Page metadata
    'page_metadata' => 'ページメタデータ',
    'metadata_page_x' => '{x}のメタデータを表示', // Don't replace {x}
    'keywords' => 'キーワード',
    ...
    'confirm_leave_site' => 'サイトを離れようとしています。<strong id = "leaveSiteURL"> {x} </strong>にアクセスしてもよろしいですか？', // don't replace {x} and make sure it has the id leaveSiteURL
    ...
    'announcement_icon_instructions' => 'また、<a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" rel="noopener nofollow">Font Awesome</a>や<a href="https://fomantic-ui.com/elements/icon.html" target="_blank" rel="noopener nofollow">Fomantic UI</a>などを使用して、ここで各お知らせにアイコンを追加することができます。',
    'header' => 'ヘッダー',
    'message' => 'メッセージ',
    'text_colour' => 'テキスト色',
    ...
    'unlink_account_success' => '{x}からアカウントの連携を解除することに成功しました。', // Don't replace {x}
];
