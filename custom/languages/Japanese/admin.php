...
$language = [
    ...
    'x_directory_not_writable' => '<strong>{x}</strong>ディレクトリは書き込み可能ではありません！',
    ...
    'new_version_x' => '新しいバージョン: <strong>{x}</strong>',
