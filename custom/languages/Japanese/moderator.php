...
$language = [
    ...
    '1_open_report' => '現在 1 件の公開レポートがあります。',
    'open_reports' => '現在 {{count}} 件の公開レポートがあります。',
    ...
    'website' => 'ウェブサイト',
    'ingame' => 'ゲーム内',
    'x_closed_report' => '{{user}} がレポートを閉鎖しました。',
    'x_reopened_report' => '{{user}} がレポートを再開しました。',
    ...
    'warn' => '警告',
    'ban_ip' => 'Ban IP',
    'viewing_user_x' => 'ユーザー {{user}} を表示しています。',
    ...
    'user_punished_alert' => '{x}がユーザー{y}を処罰しました。',
    'revoke' => '取り消し',
    'revoked' => '取り消されました',
    ...
    'punishment_revoked_alert' => '{x}がユーザー{y}の処罰を取り消しました。',
