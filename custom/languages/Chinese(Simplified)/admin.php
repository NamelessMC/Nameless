...
$language = [
    ...
    'send_test_email_info' => '以下按钮将尝试向您的电子邮件地址 <strong>{x}</strong> 发送电子邮件. 发送电子邮件时抛出的任何错误都将显示。',
    'send' => '发送',
    ...
    'unable_to_enable_module_dependencies' => '因为此模块依赖于被禁用的模块 {x}, 所以无法启用。',
    'unable_to_disable_module' => '无法禁用此模块 - 模块 {x} 依赖于此模块。',
    ...
    'default' => '默认配置',
    'make_default' => '作为默认配置',
    'default_template_set' => '将默认模板设置为 {x} 的操作已成功',
    'template_deactivated' => '模板已停用。',
    'template_activated' => '模板已启用。',
    'permissions' => '权限',
    'setting_perms_for_x' => '给 {x} 模板设置权限中',
    ...
    'editing_template_file_in_template' => '编辑位于模板 {y} 中的文件 {x}  ',
    ...
    'main_group' => '主权限组',
    'user_deleted' => '账号删除成功。',
    'confirm_user_deletion' => '你确定要删除账号 <strong>{x}</strong>?',
    'validate_user' => '验证账号',
    'update_uuid' => '更新 UUID',
    ...
    'delete_group' => '删除权限组',
    'confirm_group_deletion' => '你确定要删除权限组 {x}?',
    ...
    'link_to_complete_registration' => '点击链接以完成注册: {x}',
    ...
    'sitemap_last_generated_x' => '生成站点地图最近一次的时间  {x}',
