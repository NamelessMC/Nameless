...
$language = [
    ...
    // Overview
    'running_nameless_version' => '运行中 NamelessMC 的版本为 {{version}}',
    'running_php_version' => '运行中 php 的版本为 {{version}}',
    'statistics' => '统计',
    'registrations' => '注册量',
    'topics' => '话题数',
    'posts' => '帖子数',
    ...
    'discord_invite_info' => '您可点击 {{inviteLinkStart}}此处{{inviteLinkEnd}} 来将 Nameless Link 机器人添加到您的 Discord 服务器中。添加完毕后，请运行指令 <code>/apiurl</code> 来将网站和机器人链接起来。 您也可以 {{selfHostLinkStart}}自建机器人{{selfHostLinkEnd}}。',
    ...
    'send_test_email_info' => '以下按钮将尝试向您的电子邮件地址 {{email}} 发送电子邮件. 发送电子邮件时抛出的任何错误都将显示。',
    'send' => '发送',
    ...
    'author' => '作者:',
    'author_x' => '作者: {{author}}',
    'module_outdated' => '我们检测到该模块适用于 Nameless 版本 {{intendedVersion}}, 但你正运行 Nameless 版本 {{actualVersion}}',
    'find_modules' => '寻找模块',
    'view_all_modules' => '查看所有模块',
    'unable_to_retrieve_modules' => '无法检索模块',
    'module' => '模块',
    'unable_to_enable_module' => '无法启用不兼容的模块。',
    'unable_to_enable_module_dependencies' => '因为此模块依赖于被禁用的模块 {{module}}, 所以无法启用。',
    'unable_to_disable_module' => '无法禁用此模块 - 模块 {{module}} 依赖于此模块。',

    // Styles
    'templates' => '模板',
    'panel_templates' => '面板模板',
    'view_all_panel_templates' => '查看所有面板模版',
    'template_outdated' => '我们检测到您的模板适用于 Nameless 版本 {{intendedVersion}}, 但你正在运行 Nameless 版本 {{actualVersion}}',
    ...
    'default' => '默认配置',
    'make_default' => '作为默认配置',
    'default_template_set' => '将默认模板设置为 {{template}} 的操作已成功',
    ...
    'background_image_x' => '背景图片: {{imageName}}',
    'banner_image_x' => '条幅图片: {{imageName}}',
    'x_directory_not_writable' => '已被选择的 {{directory}} 目录不可写!',
    ...
    'template' => '模板',
    'stats' => '统计',
    'downloads_x' => '下载次数: {{downloads}}',
    'views_x' => '浏览量: {{views}}',
    'rating_x' => '评价: {{rating}}',
    'editing_template_x' => '编辑模板 {{template}} 中',
    'editing_template_file_in_template' => '编辑位于模板 {{template}} 中的文件 {{file}}',
    ...
    'main_group' => '主权限组',
    'user_deleted' => '账号删除成功。',
    'confirm_user_deletion' => '你确定要删除账号 {{user}}?',
    'validate_user' => '验证账号',
    'update_uuid' => '更新 UUID',
    ...
    'delete_group' => '删除权限组',
    'confirm_group_deletion' => '你确定要删除权限组 {{group}}?',
    ...
    // Updates
    'update' => '更新',
    'current_version_x' => '当前版本: {{version}}',
    'new_version_x' => '新版本: {{version}}',
    ...
    'editing_widget_x' => '编辑小部件 {{widget}} 中',
    'module_x' => '模块: {{module}}',
    'widget_order' => '小部件顺序',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => '无法加载站点地图文件 {{file}}',
    ...
    'sitemap_last_generated_x' => '生成站点地图最近一次的时间  {{generatedAt}}',
