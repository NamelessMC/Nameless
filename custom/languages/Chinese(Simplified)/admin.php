...
$language = [
    ...
    'background_image_x' => '背景图片: <strong>{x}</strong>',
    'banner_image_x' => '条幅图片: <strong>{x}</strong>',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => '无法加载站点地图文件 {x}',
