...
$language = [
    ...
    'api_endpoints_info' => 'API 结点允许模块添加第三方程序 (例如 Minecraft 和 Discord) 与您的 NamelessMC 网站互动的方法。<a href="https://docs.namelessmc.com/development/2.0/api" target="_blank">Check out the API documentation here</a>',
    'route' => '路径',
