...
$language = array(
	...
	'textarea' => '文本框',
	'date' => '日期',
	'creating_profile_field' => '创建空间资料字段中',
	'editing_profile_field' => '编辑空间资料字段中',
	'field_name' => '资料字段名称',
	...
	'description' => '描述',
	'display_field_on_forum' => '是否在论坛允许公开访问您的空间?',
	'profile_field_forum_help' => '如果启用，则该字段将显示在论坛帖子旁边的用户栏那。',
	'profile_field_editable_help' => '如果启用，用户可在他们的配置设置中修改空间。',
	'no_custom_fields' => '此处尚无自定义空间。',
	'profile_field_updated_successfully' => '配置的字段更新成功。',
	'profile_field_created_successfully' => '空间成功创建。',
	'profile_field_deleted_successfully' => '空间成功删除。',
    ...
    'server_address_help' => '这是用于连接服务器的IP地址或域名，没有端口。',
    'server_port' => '服务器端口',
    'parent_server' => '父服务器',
	...
	'discord_hooks_info' => '当您的网站发生问题时，向Discord频道发送消息。在Discord Server设置-> Webhooks选项卡中创建Discord Hook。',
	'discord_hook_url' => 'Discord webhook URL',
	'discord_hook_events' => '是否启用 Discord hook 事件 (Ctrl +单击以选择多个事件)',
