...
$language = [
    ...
    '1_open_report' => '目前有 1 个处于活跃状态的报告',
    'open_reports' => '目前有 {{count}} 个处于活跃状态的报告',
    ...
    'website' => '网站',
    'ingame' => '游戏内',
    'x_closed_report' => '{{user}} 关闭此报告。',
    'x_reopened_report' => '{{user}} 重开了此报告。',
    ...
    'user_punished_alert' => '{x} 对 {y} 实行了处罚',
    'revoke' => '撤消惩罚',
    'revoked' => '已撤销',
    'acknowledged' => '已承认错误',
    ...
    'punishment_revoked_alert' => '{x} 对 {y} 所受的惩罚进行了撤销',
