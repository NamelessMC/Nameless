...
$language = array(
    ...
    'install' => '安装',
    'pre-release' => '预览版本',
    'installer_welcome' => '欢迎使用 NamelessMC 版本 2.0 预发行。',
    ...
    'friendly_urls' => '友好URLs',
    'friendly_urls_info' => '友好的URL将提高浏览器中URL的可读性。<br />打个比方: <br />example.com/index.php?route=/forum<br />将会变成<br />example.com/forum.<br /><strong>注意！</strong><br />您的服务器必须正确配置才能正常工作。您可以通过单击查看是否可以启用此选项 <a href=\'./rewrite_test\' target=\'_blank\'>查看</a>.',
    'enabled' => '启用',
    'disabled' => '禁用',
    'character_set' => '字符集',
    ...
    'configuration_error' => '请输入有效的网站名称，长度在1到32个字符之间，有效的电子邮箱地址在4到64个字符之间。',
    'site_name' => '网站名称',
    'contact_email' => '联系邮箱',
    'outgoing_email' => '发件箱',
    ...
    'input_minimum' => '请确保您的用户名至少3个字符，您的电子邮箱地址至少4个字符，密码至少6个字符。',
    'input_maximum' => '请确保您的用户名不超过20个字符，您的电子邮件地址和密码不超过64个字符。',
    ...
    'upgrade' => '升级',
    'input_v1_details' => '请输入您的Nameless v1安装的数据库详细信息。',
