 ...
 *  Translation progress(v2-pr6) : 99.6%
 */
...
$language = array(
	...
	'tfa_code' => '如果您的设备没有摄像头，或者您无法扫描QR码，请输入以下代码:',
	...
	'i_agree' => '我同意',
	'agree_t_and_c' => '通过点击 <strong class="label label-primary">注册</strong>, 代表您同意我们的 <a href="{x}" target="_blank">条款和条件</a>.',
	...
	'accept_terms' => '注册前，您必须接受条款和条件。',
	'username_minimum_3' => '您的用户名必须至少包含3个字符。',
	'mcname_minimum_3' => '您的 Minecraft 玩家名必须至少包含3个字符。',
	'password_minimum_6' => '您的密码必须至少为6个字符。',
	'username_maximum_20' => '您的用户名不能超过20个字符。',
	'mcname_maximum_20' => '您的Minecraft玩家名不能超过20个字符。',
	'password_maximum_30' => '您的密码不能超过30个字符。',
	...
	'mcname_lookup_error' => '与Mojang的服务器通信以验证您的玩家名时出错。请稍后再试。',
	'invalid_recaptcha' => '无效的reCAPTCHA响应。.',
	'verify_account' => '验证账户',
	'verify_account_help' => '请按照以下说明进行操作，以便我们可以验证您是否拥有相应的Minecraft帐户。',
	...
	'uuid_already_exists' => '您的UUID已经存在，这意味着该Minecraft帐户已经注册。',
	...
	'invalid_wall_post' => '请确保您的留言长度在1到10000个字符之间。',
	'1_reaction' => '1 表态',
	...
	'title_min_2' => '标题必须至少2个字符',
	'content_min_2' => '内容必须至少2个字符',
	'title_max_64' => '标题不得超过64个字符',
	'content_max_20480' => '内容不得超过20480个字符',
	'max_pm_10_users' => '您最多只能向10个用户发送一条讯息',
	...
	'discord_id_confirm' => '请您向 "Nameless Link#0761" 发送一条只包含您的用户名的私信来确认您的 Discord 用户 ID。',
	'pending_link' => '待定',
