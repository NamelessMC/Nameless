...
$language = [
    ...
    // Profile settings
    'field_is_required' => '{{field}} 是必须要填写的。',
    ...
    'new_reply' => '新的回复',
    'registered' => '注册时间:',
    'registered_x' => '注册时间: {{registeredAt}}',
    'last_seen' => '最近一次在线时间:',
    'last_seen_x' => '最近一次在线时间: {{lastSeenAt}}',
    'new_wall_post' => '{{author}} 已发布在您的个人资料上。',
    ...
    'new_wall_post_reply' => '{{author}} 已在 {{user}} 于您的留言板留言',
     ...
     *  Hooks
     */
    'user_x_has_registered' => '{{user}} 加入了 {{siteName}}!',
