...
$language = [
    ...
    'background_image_x' => 'Obrázek na pozadí: <strong>{x}</strong>',
    'banner_image_x' => 'Bannerový obrázek: <strong>{x}</strong>',
    'logo_image_x' => 'Logo: <strong>{x}</strong>',
    'favicon_image_x' => 'Favikona: <strong>{x}</strong>',
    ...
    'editing_user_x' => 'Úprava uživatele {x}',
    'details' => 'Podrobnosti',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Nepodařilo se načíst soubor Sitemap {x}',
    ...
    'metadata_page_x' => 'Zobrazování metadat stránky {x}',
