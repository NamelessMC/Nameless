...
$language = [
    ...
    'x_directory_not_writable' => 'Adresář <strong>{x}</strong> není zapisovatelný!',
    ...
    'editing_template_x' => 'Úprava šablony {x}',
    ...
    // Updates
    'update' => 'Aktualizovat',
    'current_version_x' => 'Současná verze: <strong>{x}</strong>',
    'new_version_x' => 'Nová verze: <strong>{x}</strong>',
    ...
    'editing_page_x' => 'Úprava stránky {x}',
