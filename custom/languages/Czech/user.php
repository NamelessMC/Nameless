...
$language = [
    ...
    // Profile settings
    'field_is_required' => 'Pole {{field}} je vyžadováno.',
    ...
    'post_on_wall' => 'Zveřejnit na zdi uživatele {{user}}',
    'invalid_wall_post' => 'Ujistěte se, že váš příspěvek obsahuje mezi 1 a 10 000 znaky.',
    '1_reaction' => '1 reakce',
    'x_reactions' => '{{count}} reakcí',
    '1_like' => '1 líbí se mi',
    'x_likes' => '{{count}} líbí se mi',
    '1_reply' => '1 odpověď',
    ...
    'registered_x' => 'Zaregistrován: {{registeredAt}}',
    'last_seen' => 'Naposledy spatřen:',
    'last_seen_x' => 'Naposledy spatřen: {{lastSeenAt}}',
    'new_wall_post' => '{{author}} zveřejnil příspěvek na vaší zdi.',
    ...
    'new_wall_post_reply' => '{{author}} odpověděl na váš příspěvek na profilu uživatele {{user}}.',
