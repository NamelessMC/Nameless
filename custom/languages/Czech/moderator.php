...
$language = [
    ...
    '1_account_with_ip' => 'Byl nalezen 1 účet s IP adresou {{address}}', // Don't replace "{y}"
    'count_accounts_with_ip' => 'Bylo nalezeno {{count}} účtů s IP adresou {{address}}', // Don't replace "{x}" "{y}"
    '1_ip_with_name' => 'U uživatele {{user}} byla nalezena 1 IP adresa', // Don't replace "{y}"
    'count_ips_with_name' => 'U uživatele {{user}} bylo nalezeno {{count}} IP adres', // Don't replace "{x}" "{y}"
    ...
    '1_open_report' => 'Momentálně je otevřeno 1 nahlášení.',
    'open_reports' => 'Momentálně je otevřeno {{count}} nahlášení.',
    ...
    'website' => 'Web',
    'ingame' => 'Ve hře',
    'x_closed_report' => '{{user}} uzavřel toto nahlášení.',
    'x_reopened_report' => '{{user}} znovu otevřel toto nahlášení.',
    ...
    'warn' => 'Varovat',
    'ban_ip' => 'Zabanovat IP',
    'viewing_user_x' => 'Prohlížení uživatele {{user}}',
    ...
    'user_punished_alert' => '{{staffUser}} potrestal uživatele {{user}}',
    'revoke' => 'Odvolat',
    'revoked' => 'Odvolán',
    'acknowledged' => 'Uznáno',
