...
$language = array(
    ...
    'count_accounts_with_ip' => 'Nalezeno {x} účtů s IP {y}', // Don't replace "{x}" or "{y}"
    ...
    'report_comment_invalid' => 'Nezadali jste komentář. Musíte zadat komentář s minimálně 5 znaky.',
    ...
    'open_reports' => 'V současné době je otevřeno <strong>{x}</strong> nahlášení.', // Don't replace {x}
    'no_open_reports' => 'V současné době nejsou otevřena žádná nahlášení.',
    'no_closed_reports' => 'V současné době není uzavřeno žádné nahlášení.',
    'recent_reports' => 'Nedávná nahlášení',
    'reported_by' => 'Nahlášen uživatelem:',
    'website' => 'Web',
    'ingame' => 'Ve hře',
