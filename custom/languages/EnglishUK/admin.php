...
$language = array(
    ...
    'server_rcon_settings' => 'Rcon settings',
    'server_enable_rcon_status' => 'Enable RCON?',
    'server_rcon_port' => 'Rcon port',
    'server_rcon_pass' => 'Rcon password',
    'server_enable_rcon_status_help' => 'Enable RCON for this server? Also RCON must be enabled in the Minecraft Server settings in the file server.properties line enable-rcon=true',
    'server_rcon_port_help' => 'RCON port is listed in the file server.properties line rcon.port=',
    'server_rcon_pass_help' => 'RCON password is listed in the file server.properties line rcon.password=',
    'server_rcon_pass_hidden' => 'Password hidden',
    'rcon_port_maximum' => 'Please ensure your rcon port is a maximum of 5 characters',
    'no_rcon_servers' => 'No servers with RCON configured',
    'server_rcon_all_permissions' => 'Access to all RCON servers',
    'server_rcon_list_permissions' => 'Access to viewing the list of RCON servers',
