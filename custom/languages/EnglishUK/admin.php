...
$language = [
    ...
    'send_test_email_info' => 'The following button will attempt to send an email to your email address, {{email}}. Any errors thrown whilst sending the email will be displayed.',
    'send' => 'Send',
    ...
    'default_template_set' => 'Default template set to {{template}} successfully.',
    'template_deactivated' => 'Template deactivated.',
    'template_activated' => 'Template activated.',
    'permissions' => 'Permissions',
    'setting_perms_for_x' => 'Setting permissions for template {{template}}',
    ...
    'background_image_x' => 'Background image: {{imageName}}',
    ...
    'editing_template_x' => 'Editing template {{template}}',
    'editing_template_file_in_template' => 'Editing file {{file}} in template {{template}}',
    ...
    'confirm_user_deletion' => 'Are you sure you want to delete the user {{user}}?',
    ...
    'confirm_group_deletion' => 'Are you sure you want to delete the group {{group}}?',
    ...
    'editing_user_x' => 'Editing user {{user}}',
    'details' => 'Details',
    ...
    // Updates
    'update' => 'Update',
    'current_version_x' => 'Current version: {{version}}',
    'new_version_x' => 'New version: {{version}}',
    ...
    'editing_widget_x' => 'Editing widget {{widget}}',
    ...
    'view_page' => 'View Page?',
    'editing_page_x' => 'Editing Page {{page}}',
    ...
    'link_to_complete_registration' => 'Link to complete registration: {{link}}',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Unable to load sitemap file {{file}}',
    ...
    'sitemap_last_generated_x' => 'The sitemap was last generated {{generatedAt}}',
