...
$language = [
    ...
    // Overview
    'running_nameless_version' => 'Running NamelessMC version {{version}}', // Don't replace "{x}"
    'running_php_version' => 'Running PHP version {{version}}', // Don't replace "{x}"
    ...
    'missing_contact_address' => 'Please insert a contact email address between {{min}} and {{max}} characters long.',
    ...
    'config_not_writable' => 'Your core/config.php file is not writable. Please check file permissions.',
    ...
    'unable_to_write_email_config' => 'Unable to write to file {{file}}. Please check file permissions.',
    ...
    'mailer_settings_info' => 'The following fields are required if you have enabled PHPMailer.',
    'host' => 'Host',
    'email_port' => 'Port',
    ...
    'email_language_info' => 'Not seeing your language? Make sure {{file}} is in your language directory and it is writable by your webserver.',
    ...
    'send_test_email_info' => 'The following button will attempt to send an email to your email address, {{email}}. Any errors thrown whilst sending the email will be displayed.', // Don't replace {x}
    'send' => 'Send',
    ...
    'navbar_icon_instructions' => 'You can also add an icon to each navbar item here, for example using Font Awesome or Semantic UI.',
    ...
    'invalid_recaptcha_settings' => 'Invalid {{recaptchaProvider}} credentials. Ensure the site key and site secret are correct.', // Don't replace {x}
    ...
    'server_query_port_help' => 'This is the query.port option in your server\'s server.properties, provided the enable-query option in the same file is set to true.',
    ...
    'content' => 'Content',
    'mcassoc_help' => 'mcassoc is an external service which can be used to verify users own the Minecraft account they have registered with. To use this feature, you will need to sign up for a shared key: {{url}}.',
    'mcassoc_key' => 'mcassoc Shared Key',
    'mcassoc_instance' => 'mcassoc Instance Key',
    'mcassoc_instance_help' => 'Click to generate an instance key',
    ...
    'server_id_x' => 'Server ID: {{serverId}}', // Don't replace {x}
    ...
    'author' => 'Author:',
    'author_x' => 'Author: {{author}}', // Don't replace {x}
    'updated_x' => 'Updated at: {{updatedAt}}', // Don't replace {x}
    'module_outdated' => 'We have detected that this module is intended for Nameless version {{intendedVersion}}, but you are running Nameless version {{actualVersion}}', // Don't replace "{x}" or "{y}"
    ...
    'unable_to_enable_module_dependencies' => 'Unable to enable module since it depends on the module {{module}}, which is not enabled.', // Don't replace {x}
    'unable_to_disable_module' => 'Unable to disable module - the module {{module}} depends on it.', // Don't replace {x}

    // Styles
    'templates' => 'Templates',
    'panel_templates' => 'Panel Templates',
    'view_all_panel_templates' => 'View all panel templates',
    'template_outdated' => 'We have detected that your template is intended for Nameless version {{intendedVersion}}, but you are running Nameless version {{actualVersion}}', // Don't replace "{x}" or "{y}"
    ...
    'default_template_set' => 'Default template set to {{template}} successfully.', // Don't replace {x}
    'template_deactivated' => 'Template deactivated.',
    'template_activated' => 'Template activated.',
    'permissions' => 'Permissions',
    'setting_perms_for_x' => 'Setting permissions for template {{template}}', // Don't replace {x}
    ...
    'background_image_x' => 'Background image: {{imageName}}', // Don't replace {x}
    'banner_image_x' => 'Banner image: {{imageName}}', // Don't replace {x}
    'logo_image_x' => 'Logo image: {{imageName}}', // Don't replace {x}
    'favicon_image_x' => 'Favicon image: {{imageName}}', // Don't replace {x}
    'x_directory_not_writable' => 'The {{directory}} directory is not writable!', // Don't replace {x}
    ...
    'editing_template_x' => 'Editing template {{template}}', // Don't replace {x}
    'editing_template_file_in_template' => 'Editing file {{file}} in template {{template}}', // Don't replace {x} or {y}
    ...
    'confirm_user_deletion' => 'Are you sure you want to delete the user {{user}}?', // Don't replace {x}
    ...
    'confirm_group_deletion' => 'Are you sure you want to delete the group {{group}}?', // Don't replace {x}
    ...
    'editing_user_x' => 'Editing user {{user}}', // Don't replace {x}
    'details' => 'Details',
    ...
    // Updates
    'update' => 'Update',
    'current_version_x' => 'Current version: {{version}}', // Don't replace {x}
    'new_version_x' => 'New version: {{version}}', // Don't replace {x}
    ...
    'editing_widget_x' => 'Editing widget {{widget}}', // Don't replace {x}
    'module_x' => 'Module: {{module}}', // Don't replace {x}
    ...
    'view_page' => 'View Page?',
    'editing_page_x' => 'Editing Page {{page}}', // Don't replace {x}
    ...
    'api_info' => 'The API allows for plugins and other services to interact with your website, such as the official Nameless plugin and the official NamelessMC Discord Bot.',
    ...
    'link_to_complete_registration' => 'Link to complete registration: {{link}}', // Don't replace {x}
    'api_verification' => 'Enable API verification?',
    'api_verification_info' => 'If enabled, accounts can only be verified through the API, for example ingame using the official Nameless plugin. This option will override email verification, and accounts will be automatically activated!\nYou should set up your default group to have limited permissions, and then update the post-validation group in the StaffCP -> Configuration -> Registration tab to the full member group with normal permissions.',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Unable to load sitemap file {{file}}', // Don't replace {x}
    'sitemap_generated' => 'Sitemap generated successfully',
    'sitemap_not_writable' => 'The cache/sitemaps directory is not writable.',
    ...
    'sitemap_last_generated_x' => 'The sitemap was last generated {{generatedAt}}', // Don't replace {x}

    // Page metadata
    'page_metadata' => 'Page Metadata',
    'metadata_page_x' => 'Viewing metadata for page {{page}}', // Don't replace {x}
    'keywords' => 'Keywords',
    ...
    'confirm_leave_site' => 'You are about to leave this site! Are you sure you want to visit {{link}}?', // don't replace {x} and make sure it has the id leaveSiteURL
    'server_compatibility' => 'Server Compatibility',

    // Other
    'source' => 'Source',
    'support' => 'Support',
    'admin_dir_still_exists' => 'Warning! The {{directory}} directory still exists. Please remove this directory.',
    'mod_dir_still_exists' => 'Warning! The {{directory}} directory still exists. Please remove this directory.',
    ...
    'announcement_icon_instructions' => 'You can also add an icon to each announcement here, for example using Font Awesome or Semantic UI.',
    'header' => 'Header',
    'message' => 'Message',
