...
$language = [
    ...
    'confirm_spam' => 'Are you sure you want to mark this user as spam?\nThe user will be IP banned, and all their content will be removed.',
    ...
    '1_account_with_ip' => 'Found {{count}} account with the IP {{address}}', // Don't replace "{y}"
    'count_accounts_with_ip' => 'Found {{count}} accounts with the IP {{address}}', // Don't replace "{x}" or "{y}"
    '1_ip_with_name' => 'Found {{count}} IP address for user {{user}}', // Don't replace "{y}"
    'count_ips_with_name' => 'Found {{count}} IP addresses for user {{user}}', // Don't replace "{x}" or "{y}"
    ...
    'report_comment_invalid' => 'Invalid comment content. Please ensure you have entered a comment between {{min}} and {{max}} characters.',
    'close_report' => 'Close report',
    'reopen_report' => 'Reopen report',
    '1_open_report' => 'There is currently {{count}} open report.',
    'open_reports' => 'There are currently {{count}} open reports.', // Don't replace {x}
    ...
    'website' => 'Website',
    'ingame' => 'Ingame',
    'x_closed_report' => '{{user}} closed this report.', // Don't replace {x} (username)
    'x_reopened_report' => '{{user}} reopened this report.', // Don't replace {x} (username)
    ...
    'warn' => 'Warn',
    'ban_ip' => 'Ban IP',
    'viewing_user_x' => 'Viewing user {{user}}', // Don't replace {x}
    ...
    'user_punished_alert' => '{{staffUser}} has punished user {{user}}', // Don't replace {x} (staff member) or {y} (user punished)
    'revoke' => 'Revoke',
    'revoked' => 'Revoked',
    ...
    'punishment_revoked_alert' => '{{staffUser}} has revoked a punishment for user {{user}}', // Don't replace {x} (staff member) or {y} (user with revoked punishment)
