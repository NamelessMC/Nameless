...
$language = [
    ...
    '404_back' => 'Go back',
    '404_home' => 'Home',
    '404_error' => 'If you believe this to be an error, {{linkStart}}please contact an administrator{{linkEnd}}', // Don't replace {x} or {y}
    '403_title' => 'Sorry!',
    ...
    'in_file' => 'in file {{file}}', // Don't replace {x}
    'on_line' => 'on line {{line}}' // Don't replace {x}
];
