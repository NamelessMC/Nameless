...
$language = [
    ...
    'configuration_error' => 'Please input a valid site name between {{minSiteName}} and {{maxSiteName}} characters long, and valid email addresses between {{minSiteEmail}} and {{maxSiteEmail}} characters long.',
    'site_name' => 'Site Name',
