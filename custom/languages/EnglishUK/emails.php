...
$language = [
    ...
    // Forum Topic Replies
    'forum_topic_reply_subject' => '{{author}} has replied to {{user}}', // Don't remove {x} or {y}
    'forum_topic_reply_message' => '{{author}} has replied to a topic you follow. Content: {{content}}' // Don't remove {x} or {z}
];
