...
$language = [
     ...
     */
    'validate_account_command' => 'Para completar el registro, ejecuta el comando /verify {{command}} dentro del juego.',
    ...
    // Profile settings
    'field_is_required' => '{{field}} es necesario.',
    ...
    'x_reactions' => '{{count}} reacciones',
    '1_like' => 'Un me gusta',
    'x_likes' => '{{count}} me gusta',
    ...
    'last_seen_x' => 'Visto por última vez: {{lastSeenAt}}',
    'new_wall_post' => '{{author}} ha publicado un mensaje en tu perfil.',
    ...
    'new_wall_post_reply' => '{{author}} ha respondido a tu mensaje en el perfil de {{user}}.',
    'new_wall_post_reply_your_profile' => '{{author}} ha respondido a tu mensaje en tu perfil.',
