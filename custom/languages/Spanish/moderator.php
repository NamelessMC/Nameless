...
$language = [
    ...
    '1_account_with_ip' => 'Encontramos 1 cuenta con la IP {{address}}',
    'count_accounts_with_ip' => 'Encontró {{count}} cuentas con la IP {{address}}',
    '1_ip_with_name' => 'Se encontró una dirección IP para el usuario {{user}}',
    'count_ips_with_name' => 'Encontró {{count}} Dirección(es) IP para el usuario {{user}}',
