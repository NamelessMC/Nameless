...
$language = [
    ...
    // Profile settings
    'field_is_required' => '{x} es requerido.',
    ...
    'new_wall_post_reply' => '{x} ha respondido a tu publicación en el Perfil de {y}.',
