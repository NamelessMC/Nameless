...
$language = [
     ...
     */
    'validate_account_command' => 'Para completar la validación, ejecute el comando /verify {{command}} en el servidor.',
    ...
    'active_template' => 'Plantilla activada',
    ...
    // Alerts
    'user_tag_info' => 'Has sido etiquetado en un post por {{author}}.',
    ...
    'agree_t_and_c' => 'He leído y acepto los {{linkStart}}Términos y condiciones{{linkEnd}}.',
    ...
    'post_on_wall' => 'Publicar en el muro de {{user}}',
    'invalid_wall_post' => 'Asegúrese de que su publicación tenga entre 1 y 10000 caracteres.',
    '1_reaction' => '1 reacción',
    'x_reactions' => '{{count}} reaccciones',
    '1_like' => '1 Me gusta',
    'x_likes' => '{{count}} Me gustas',
    '1_reply' => '1 respuesta',
    'x_replies' => '{{count}} respuestas',
    ...
    'registered_x' => 'Registrado: {{registeredAt}}',
    'last_seen' => 'Ultima vez visto:',
    'last_seen_x' => 'Ultima vez visto: {{lastSeenAt}}',
    'new_wall_post' => '{{author}} ha publicado en tu Perfil.',
    ...
    'new_wall_post_reply' => '{{author}} ha respondido a tu publicación en el Perfil de {{user}}.',
    'new_wall_post_reply_your_profile' => '{{author}} ha respondido a tu publicación en tu Perfil.',
