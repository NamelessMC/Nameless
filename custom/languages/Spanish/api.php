...
$language = array(
    ...
    'unable_to_check_for_updates' => 'No se ha podido realizar el chequeo de actualizaciones',
    'invalid_post_contents' => 'Contenido POST no válido.',
    'invalid_get_contents' => 'Contenido GET no válido.',
    'invalid_email_address' => 'Dirección e-Mail no válida.',
    'invalid_username' => 'Usuario no válido.',
    'invalid_uuid' => 'UUID inválido',
    'email_already_exists' => 'Esa e-Mail ya existe.',
    'username_already_exists' => 'Ese nick ya está en uso.',
    'uuid_already_exists' => 'Esa UUID ya existe.',
    'unable_to_create_account' => 'No se ha podido crear la cuenta.',
    'unable_to_send_registration_email' => 'No se ha podido activar tu cuenta. Contáctate con un Staff para activar tu cuenta.',
    'unable_to_find_user' => 'No se ha podido encontrar a ese usuario.',
    ...
    'invalid_server_id' => 'Server ID inválida.',
