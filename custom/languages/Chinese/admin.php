...
$language = [
    ...
    'send_test_email_info' => '下面按鈕將會傳送測試電子郵件至 {{email}}. 任何錯誤都會被顯示.',
    'send' => '傳送',
    ...
    'default' => '預設',
    'make_default' => '設為預設',
    'default_template_set' => '預設樣式已設定為 {{template}}.',
    ...
    'confirm_user_deletion' => '你確定要移除 {{user}}?',
    'validate_user' => '驗證使用者',
    'update_uuid' => '更新 UUID',
    ...
    'group_staff' => '這是管理群組?',
    'delete_group' => '移除群組',
    'confirm_group_deletion' => '確定要移除群組 {{group}}?',
