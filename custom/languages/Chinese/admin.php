...
$language = [
    ...
    // Overview
    'running_nameless_version' => '使用中NamelessMC版本 {{version}}',
    'running_php_version' => '使用中PHP版本 {{version}}',
    'statistics' => '統計',
    ...
    'unable_to_write_email_config' => '無法寫入<strong>core/email.php</strong>. 請檢查權限.',
    ...
    'send_test_email_info' => '下面按鈕將會傳送測試電子郵件至 <strong>{x}</strong>. 任何錯誤都會被顯示.',
    'send' => '傳送',
    ...
    'default' => '預設',
    'make_default' => '設為預設',
    'default_template_set' => '預設樣式已設定為 {x} .',
    'template_deactivated' => '樣式停用.',
    'template_activated' => '樣式啟用.',
    'permissions' => '權限',
    'setting_perms_for_x' => '設定樣式 {x} 權限',
    ...
    'confirm_user_deletion' => '你確定要移除 <strong>{x}</strong>?',
    'validate_user' => '驗證使用者',
    'update_uuid' => '更新 UUID',
    ...
    'group_staff' => '這是管理群組?',
    'delete_group' => '移除群組',
    'confirm_group_deletion' => '確定要移除群組 {x}?',
    ...
    'view_site' => '返回網站',
    'signed_in_as_x' => '目前使用<strong>{x}</strong>登入',
    'warning' => '警告',
    ...
    // Updates
    'update' => '更新',
    'current_version_x' => '目前版本: {{version}}',
