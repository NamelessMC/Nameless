...
$language = [
    ...
    'post_on_wall' => 'Skriv en kommentar på {{user}} sin vegg',
    ...
    'registered_x' => 'Registrerte seg: {{registeredAt}}',
    'last_seen' => 'Sist sett:',
    'last_seen_x' => 'Sist sett: {{lastSeenAt}}',
    'new_wall_post' => '{{author}} har skrevet en kommentar på profilsiden din.',
    ...
    'new_wall_post_reply' => '{{author}} har svart på innlegget ditt på {{user}} sin profil.',
    ...
    'max_pm_10_users' => 'Meldingen kan kun sendes til maks 10 personer samtidig.',
    ...
    'one_or_more_users_blocked' => 'Du kan ikke sende private meldinger til minst en av personene i samtalen.',
    'messages' => 'Meldinger',
