...
$language = [
    ...
    'module_outdated' => 'Det ser ut som denne modulen hører til NamelessMC versjon {x}, men du bruker versjon {y}',
    ...
    'unable_to_enable_module_dependencies' => 'Kunne ikke aktivere modul siden den er avhengig av modulen {{module}}, som ikke er aktivert.',
    'unable_to_disable_module' => 'Kunne ikke deaktivere modul - modulen {{module}} avhenger av den.',
    ...
    'default_template_set' => 'Din standardmal er nå {{template}}.',
    ...
    'editing_template_file_in_template' => 'Redigerer filen {{file}} i malen {{template}}',
    ...
    'confirm_user_deletion' => 'Er du sikker på at du vil slette brukeren {{user}}?',
    ...
    'confirm_group_deletion' => 'Er du sikker på at du vil slette gruppen {{group}}?',
    ...
    'sitemap_last_generated_x' => 'Sitemapen ble sist generert {{generatedAt}}',
