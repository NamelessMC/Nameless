...
$language = array(
    ...
    'service_query_error' => 'Kunne ikke hente Service Status',
    'authme_integration' => 'AuthMe Integrering',
    'authme_integration_info' => 'Når AuthMe integreringen er aktivert, kan man kun registrere seg ingame.',
    'enable_authme' => 'Aktiver AuthMe integrering?',
    'authme_db_address' => 'AuthMe Database Adresse',
    'authme_db_port' => 'AuthMe Database Port',
    'authme_db_name' => 'AuthMe Database Navn',
    'authme_db_user' => 'AuthMe Database Brukernavn',
    'authme_db_password' => 'AuthMe Database Passord',
    'authme_hash_algorithm' => 'AuthMe Hash\'er Algorithm',
    'authme_db_table' => 'AuthMe Bruker tabell',
    'enter_authme_db_details' => 'Vennligst skriv inn gyldige database informasjoner.',
    'authme_password_sync' => 'Synkroniser AuthMe passord?',
    'authme_password_sync_help' => 'Hvis aktivert, når en brukers passord er oppdatert ingame, vil den også bli oppdatert på nettsiden.',
    'minecraft_servers' => 'Minecraft Servere',
    'account_verification' => 'Minecraft Bruker Verifisering',
    'server_banners' => 'Server Bannere',
    'query_errors' => 'Query Error',
    'add_server' => '<i class="fa fa-plus-circle"></i> Leggtil Server',
    'adding_server' => 'Legger til Server',
    'server_name' => 'Server Navn',
    'server_address' => 'Server Adresse',
    'server_address_help' => 'Dette er IP adressen eller domenet som blir brukt når man logger inn på serveren din. Du kan også legge til server port også, hvis nødvendig.',
	// Modules
