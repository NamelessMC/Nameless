...
$language = [
    ...
    'x_directory_not_writable' => '<strong>{x}</strong>-mappen er ikke redigerbar!',
    ...
    'editing_template_x' => 'Redigerer mal {x}',
    ...
    'new_version_x' => 'Ny versjon: <strong>{x}</strong>',
    ...
    'view_page' => 'Se side?',
    'editing_page_x' => 'Redigerer side {x}',
