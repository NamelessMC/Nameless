...
$language = [
    ...
    'background_image_x' => 'Arka Plan resmi: <strong>{x}</strong>',
    'banner_image_x' => 'Afiş(Banner) resmi: <strong>{x}</strong>',
    ...
    'editing_user_x' => '{x} Isimli Kullanıcı Düzenleniyor...',
    'details' => 'Detaylar',
    ...
    'signed_in_as_x' => '{x} olarak oturum açıldı',
    'warning' => 'Uyarı',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => '{x} site haritası dosyası yüklenemedi',
    ...
    'metadata_page_x' => '{x} sayfası için meta verileri görüntüleme',
