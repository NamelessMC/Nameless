...
$language = [
    ...
    'running_php_version' => 'PHP Sürümü {{version}}',
    ...
    'send_test_email_info' => 'Aşağıdaki düğme, e-posta adresinize <strong>{x}</strong> bir e-posta göndermeye çalışacaktır. E-posta gönderilirken atılan hatalar görüntülenir.',
    'send' => 'Gönder',
    ...
    'default_template_set' => 'Varsayılan şablon başarıyla {x} olarak ayarlandı.',
    'template_deactivated' => 'Şablon devre dışı bırakıldı!',
    'template_activated' => 'Şablon aktif edildi!',
    'permissions' => 'Yetkiler',
    'setting_perms_for_x' => '{x} şablonu için izinleri ayarlama',
    ...
    'editing_template_file_in_template' => '{y} şablonundaki {x} dosyasını düzenleme',
    ...
    'confirm_user_deletion' => '<strong>{x}</strong> kullanıcısını silmek istediğinizden emin misiniz?',
    ...
    'confirm_group_deletion' => '{x} grubunu silmek istediğinizden emin misiniz?',
    ...
    'sitemap_last_generated_x' => 'Site haritası en son oluşturuldu {x}',
