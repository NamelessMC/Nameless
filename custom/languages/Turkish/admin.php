...
$language = [
    ...
    'x_directory_not_writable' => '<strong>{x}</strong> dizini yazılamaz!',
    ...
    'editing_template_x' => '{x} isimli şablon düzenleniyor..',
    ...
    // Updates
    'update' => 'Güncelle',
    'current_version_x' => 'Şimdiki versiyonu: <strong>{x}</strong>',
    'new_version_x' => 'Yeni versiyonu: <strong>{x}</strong>',
    ...
    'editing_page_x' => '{x} isimli sayfayı düzenleniyor..',
