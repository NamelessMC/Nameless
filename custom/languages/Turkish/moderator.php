...
$language = [
    ...
    '1_open_report' => 'Şu anda 1 açık rapor var.',
    'open_reports' => 'Şu anda {{count}} açık rapor var.',
    ...
    'website' => 'Site',
    'ingame' => 'Oyunda',
    'x_closed_report' => '{{user}} bu raporu kapattı.',
    'x_reopened_report' => '{{user}} bu raporu tekrar açtı',
    ...
    'viewing_user_x' => 'Kullanıcı {{user}} görüntüleniyor',
    ...
    'user_punished_alert' => '{x} kullanıcıyı cezalandırdı {y}',
    'revoke' => 'Iptal Et',
    ...
    'punishment_revoked_alert' => '{x}, {y} kullanıcısı için bir cezayı iptal etti',
