...
$language = [
    ...
    'editing_template_x' => 'Šablono {x} redagavimas',
    ...
    // Updates
    'update' => 'Atnaujinti',
    'current_version_x' => 'Dabartinė versija: <strong>{x}</strong>',
    'new_version_x' => 'Nauja versija: <strong>{x}</strong>',
    ...
    'editing_page_x' => 'Redaguoti puslapį {x}',
