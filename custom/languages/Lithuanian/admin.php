...
$language = [
    ...
    'player_count_cronjob_info' => 'Galite nustatyti "cron job" užklausą savo serveriams kas {x} minutes, naudodami šią komandą:',
    'status_page' => 'Įjungti būsenos puslapį?',
    'minecraft_settings_updated_successfully' => 'Nustatymai atnaujinti sėkmingai.',
    'server_id_x' => 'Serverio ID: {x}',
    ...
    'background_image_x' => 'Fono vaizdas: <strong>{x}</strong>',
    ...
    'editing_user_x' => 'Redaguoti naudotoją {x}',
    'details' => 'Detalės',
    ...
    'signed_in_as_x' => 'Prisijungęs kaip {x}',
    'warning' => 'Įspėjimas',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Nepavyko įkelti svetainės schemos failo {x}',
    ...
    'metadata_page_x' => 'Puslapio {x} metaduomenų peržiūra.',
