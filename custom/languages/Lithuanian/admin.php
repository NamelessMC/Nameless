...
$language = [
    ...
    'send_test_email_info' => 'Sekantis mygtukas bandys išsiųsti el. Laišką į jūsų el. Pašto adresą, {{email}}. Bus rodomos klaidos siunčiant el. Laišką.',
    'send' => 'Siųsti',
    ...
    'module_outdated' => 'Aptikome, kad šis modulis skirtas "Nameless" versijai {{intendedVersion}}, bet jūs naudojate "Nameless" versija {{actualVersion}}',
    ...
    'default_template_set' => 'Numatytasis šablonas {{template}} sėkmingai nustatytas.',
    ...
    'editing_template_file_in_template' => 'Redaguoti failą {{file}} šablone {{template}}',
    ...
    'confirm_user_deletion' => 'Ar tikrai norite ištrinti vartotoją {{user}}?',
    ...
    'confirm_group_deletion' => 'Ar tikrai norite ištrinti grupę {{group}}?',
    ...
    'sitemap_last_generated_x' => 'Svetainės schema paskutinį kartą buvo sukurta {{generatedAt}}',
