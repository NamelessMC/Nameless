...
$language = [
    ...
    // Overview
    'running_nameless_version' => 'Veikia NamelessMC versija {{version}}',
    'running_php_version' => 'Veikia PHP versija {{version}}',
    ...
    'send_test_email_info' => 'Sekantis mygtukas bandys išsiųsti el. Laišką į jūsų el. Pašto adresą, <strong>{x}</strong>. Bus rodomos klaidos siunčiant el. Laišką.',
    'send' => 'Siųsti',
    ...
    'server_id_x' => 'Serverio ID: {{serverId}}',
    ...
    'template_outdated' => 'Mes aptikome, kad jūsų šablonas skirtas NamelessMC versijai {{intendedVersion}}, bet jūs naudojate NamelessMC versija {{actualVersion}}',
    ...
    'default_template_set' => 'Numatytasis šablonas {x} sėkmingai nustatytas.',
    'template_deactivated' => 'Šablonas išjungtas.',
    'template_activated' => 'Šablonas įjungtas.',
    'permissions' => 'Leidimai',
    'setting_perms_for_x' => 'Šablono {x} leidimų nustatymas.',
    ...
    'background_image_x' => 'Fono vaizdas: {{imageName}}',
    ...
    'template' => 'Šablonas',
    'stats' => 'Statistika',
    'downloads_x' => 'Atsisiuntimai: {{downloads}}',
    'views_x' => 'Peržiūros: {{views}}',
    'rating_x' => 'Įvertinimas: {{rating}}',
    'editing_template_x' => 'Šablono {{template}} redagavimas',
    'editing_template_file_in_template' => 'Redaguoti failą {x} šablone {y}',
    ...
    'confirm_user_deletion' => 'Ar tikrai norite ištrinti vartotoją <strong>{x}</strong>?',
    ...
    'confirm_group_deletion' => 'Ar tikrai norite ištrinti grupę {x}?',
    ...
    'editing_user_x' => 'Redaguoti naudotoją {{user}}',
    'details' => 'Detalės',
    ...
    // Updates
    'update' => 'Atnaujinti',
    'current_version_x' => 'Dabartinė versija: {{version}}',
    'new_version_x' => 'Nauja versija: {{version}}',
    ...
    'editing_widget_x' => 'Valdiklio redagavimas {{widget}}',
    'module_x' => 'Modulis: {{module}}',
    ...
    'editing_page_x' => 'Redaguoti puslapį {{page}}',
    ...
    'link_to_complete_registration' => 'Nuoroda užbaigti registracijai: {x}',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Nepavyko įkelti svetainės schemos failo {{file}}',
    ...
    'sitemap_last_generated_x' => 'Svetainės schema paskutinį kartą buvo sukurta {x}',
