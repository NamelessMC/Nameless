...
$language = [
    ...
    'open_reports' => 'Dabar yra <strong>{x}</strong> atidarytų ataskaitų.',
    ...
    'website' => 'Tinklalapis',
    'ingame' => 'Žaidime',
    'x_closed_report' => '{x} uždarė šią ataskaitą.',
    'x_reopened_report' => '{x} atnaujino šią ataskaitą.',
    ...
    'viewing_user_x' => 'Peržiūrimas Vartotojas {x}',
    ...
    'user_punished_alert' => '{x} nubaudė vartotoją {y}',
    'revoke' => 'Atšaukti',
    'revoked' => 'Atšauktas',
    ...
    'punishment_revoked_alert' => '{x} pašalino bausmę vartotojui {y}',
