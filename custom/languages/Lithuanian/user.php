...
$language = [
    ...
    // Profile settings
    'field_is_required' => 'Reikalingas {{field}}.',
    ...
    'post_on_wall' => '"Post" ant {{user}}\'s sienos',
    ...
    'registered_x' => 'Prisiregistravo: {{registeredAt}}',
    'last_seen' => 'Paskutinį kartą matytas:',
    'last_seen_x' => 'Paskutinį kartą matytas: {{lastSeenAt}}',
    'new_wall_post' => '{{author}} paskelbė ant jūsų profilio.',
    ...
    'new_wall_post_reply' => '{{author}} atsakė į jūsų "postą" {{user}}\'s profilyje.',
