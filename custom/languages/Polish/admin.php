...
$language = [
    ...
    'unable_to_write_email_config' => 'Nie można zapisać pliku <strong>core/email.php</strong>. Sprawdź uprawnienia plików.',
    ...
    'send_test_email_info' => 'Poniższy przycisk wyśle wiadomość e-mail na twój adres e-mail <strong> {x} </strong>. Zostaną wyświetlone wszystkie błędy wygenerowane podczas wysyłania wiadomości.',
    'send' => 'Wyślij',
    ...
    'unable_to_enable_module_dependencies' => 'Nie można włączyć modułu, bo moduł {x} go wymaga.',
    'unable_to_disable_module' => 'Nie można usunąć modułu - moduł {x} go wymaga.',
    ...
    'default_template_set' => 'Szablon {x} został ustawiony jako domyślny.',
    'template_deactivated' => 'Szablon został dezaktywowany.',
    'template_activated' => 'Szablon został aktywowany.',
    'permissions' => 'Uprawnienia',
    'setting_perms_for_x' => 'Ustawianie uprawnień dla szablonu {x}',
    ...
    'background_image_x' => 'Grafika w tle: <strong>{x}</strong>',
    'banner_image_x' => 'Grafika na bannerze: <strong>{x}</strong>',
    'logo_image_x' => 'Logo image: <strong>{x}</strong>',
    'favicon_image_x' => 'Favicon image: <strong>{x}</strong>',
    'x_directory_not_writable' => 'Ścieżka <strong>{x}</strong> nie jest zapisywalna!',
    ...
    'rating_x' => 'Ocena: {x}',
    'editing_template_x' => 'Edytownie szablonu {x}',
    'editing_template_file_in_template' => 'Edytownie pliku {x} w szablonie {y}',
    ...
    'confirm_user_deletion' => 'Jesteś pewien że chcesz usunąć użytkownika <strong>{x}</strong>?',
    ...
    'confirm_group_deletion' => 'Jesteś pewien że chcesz usunąć grupę {x}?',
    ...
    'editing_user_x' => 'Edytowanie użytkownika {x}',
    'details' => 'Szczegóły',
    ...
    'signed_in_as_x' => 'Zalogowany jako {x}',
    'warning' => 'Ostrzeżenie',
    ...
    'new_version_x' => 'Nowa wersja: <strong>{x}</strong>',
    ...
    'editing_widget_x' => 'Edytowanie widżetu: {x}',
    'module_x' => 'Moduł: {x}',
    ...
    'editing_page_x' => 'Edytownie strony {x}',
    ...
    'link_to_complete_registration' => 'Link do skończenia rejestracji: {x}',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Nie można załadować pliku mapy strony {x}',
    ...
    'sitemap_last_generated_x' => 'Ostatnia mapa strony została wygenerowana {x}',

    // Page metadata
    'page_metadata' => 'Metadata strony',
    'metadata_page_x' => 'Przeglądanie matadaty strony {x}',
    ...
    'confirm_leave_site' => 'Zamierzasz opuścić tę stronę! Czy na pewno chcesz przejść do <strong id="leaveSiteURL">{x}</strong>?', and make sure it has the id leaveSiteURL
