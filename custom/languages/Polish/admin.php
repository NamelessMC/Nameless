...
$language = [
    ...
    // Overview
    'running_nameless_version' => 'Wersja NamelessMC: {{version}}',
    'running_php_version' => 'Wersja PHP: {{version}}',
    ...
    'rating_x' => 'Ocena: {{rating}}',
    'editing_template_x' => 'Edytownie szablonu {{template}}',
    ...
    // Updates
    'update' => 'Zaktualizuj',
    'current_version_x' => 'Aktualna wersja: {{version}}',
    'new_version_x' => 'Nowa wersja: {{version}}',
    ...
    'editing_widget_x' => 'Edytowanie widżetu: {{widget}}',
    'module_x' => 'Moduł: {{module}}',
    ...
    'editing_page_x' => 'Edytownie strony {{page}}',
