...
$language = [
    ...
    'module_outdated' => 'Wykryliśmy, e ten moduł jest przeznaczony do wersji Nameless {{intendedVersion}}, a ty używasz wersji Nameless {{actualVersion}}',
    ...
    'unable_to_enable_module_dependencies' => 'Nie można włączyć modułu, bo moduł {{module}} go wymaga.',
    'unable_to_disable_module' => 'Nie można usunąć modułu - moduł {{module}} go wymaga.',
    ...
    'default_template_set' => 'Szablon {{template}} został ustawiony jako domyślny.',
    ...
    'editing_template_file_in_template' => 'Edytownie pliku {{file}} w szablonie {{template}}',
    ...
    'confirm_user_deletion' => 'Jesteś pewien że chcesz usunąć użytkownika {{user}}?',
    ...
    'confirm_group_deletion' => 'Jesteś pewien że chcesz usunąć grupę {{group}}?',
    ...
    'sitemap_last_generated_x' => 'Ostatnia mapa strony została wygenerowana {{generatedAt}}',
