...
$language = [
    ...
    // Errors
    'api_disabled' => 'API jest wyłączone',
    ...
    'invalid_get_contents' => 'Niepoprawna treść GET',
    'invalid_email_address' => 'Niepoprawny adres email',
    'invalid_username' => 'Niepoprawna nazwa użytkownika',
    'invalid_uuid' => 'Niepoprawne UUID',
    'email_already_exists' => 'Ten adres email już istnieje',
    ...
    'user_already_active' => 'Twoje konto jest już aktywowane.',
