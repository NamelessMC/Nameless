...
$language = array(
    ...
    'discord_invite_info' => 'Per invitare il bot di collegamento di Nameless al tuo server Discord, clicca <a target="_blank" href="https://discord.com/api/oauth2/authorize?client_id=734609142081388705&permissions=268435456&scope=bot">qui</a>. Quindi, invia un messaggio diretto al bot con il comando <code>!apiurl</code> per collegare il bot con il tuo sito web. In alternativa, puoi <a target="_blank" href="https://github.com/NamelessMC/Nameless-Link/wiki/Own-instance">ospitare tu stesso il bot</a>.',
    'dark' => 'Scuro',
    'light' => 'Chiaro',
    ...
    'google_recaptcha_login' => "Abilitare Google reCAPTCHA all'accesso?",
