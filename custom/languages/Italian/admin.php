...
$language = [
    ...
    // Overview
    'running_nameless_version' => 'Stai eseguendo NamelessMC alla versione {{version}}',
    'running_php_version' => 'Stai eseguendo PHP alla versione {{version}}',
    ...
    'send_test_email_info' => "Il seguente bottone tenterà di inviare un'email al tuo indirizzo email, <strong>{x}</strong>. Verranno visualizzati eventuali errori generati durante l'invio dell'email.",
    'send' => 'Invia',
    ...
    'unable_to_enable_module_dependencies' => 'Unable to enable module since it depends on the module {x}, which is not enabled.',
    'unable_to_disable_module' => 'Unable to disable module - the module {x} depends on it.',
    ...
    'default_template_set' => 'Modello predefinito impostato su {x} con successo.',
    'template_deactivated' => 'Modello disattivato.',
    'template_activated' => 'Modello attivato.',
    'permissions' => 'Permessi',
    'setting_perms_for_x' => 'Impostazione dei permessi per il modello {x}',
    ...
    'background_image_x' => 'Immagine di sfondo: <strong>{x}</strong>',
    'banner_image_x' => 'Immagine banner: <strong>{x}</strong>',
    ...
    'editing_template_file_in_template' => 'Modifica del file {x} nel modello {y}',
    ...
    'confirm_user_deletion' => "Sei sicuro di voler eliminare l'utente <strong>{x}</strong>?",
    ...
    'confirm_group_deletion' => 'Sei sicuro di voler eliminare il gruppo {x}?',
    ...
    'editing_user_x' => 'Modifica utente {x}',
    'details' => 'Dettagli',
    ...
    'signed_in_as_x' => 'Accesso eseguito come {x}',
    'warning' => 'Attenzione',
    ...
    // Updates
    'update' => 'Aggiorna',
    'current_version_x' => 'Versione corrente: {{version}}',
    'new_version_x' => 'Nuova versione: {{version}}',
    ...
    'editing_widget_x' => 'Modifica del widget {{widget}}',
    ...
    'editing_page_x' => 'Modifica pagina {{page}}',
    ...
    'link_to_complete_registration' => 'Link per completare la registrazione: {x}',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Impossibile caricare il file sitemap {x}',
    ...
    'sitemap_last_generated_x' => "La sitemap è stata generata l'ultima volta {x}",

    // Page metadata
    'page_metadata' => 'Metadati della pagina',
    'metadata_page_x' => 'Visualizzazione dei metadati per la pagina {x}',
    ...
    'confirm_leave_site' => 'Stai per lasciare questo sito! Sei sicuro di voler visitare <strong id="leaveSiteURL">{x}</strong>?',
