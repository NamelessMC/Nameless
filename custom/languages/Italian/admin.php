...
$language = [
    ...
    'template_outdated' => 'Abbiamo rilevato che il tuo modello è destinato alla versione {{intendedVersion}} di Nameless, ma tu stai usando la {{actualVersion}}',
    ...
    'editing_user_x' => 'Modifica utente {{user}}',
    'details' => 'Dettagli',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Impossibile caricare il file sitemap {{file}}',
