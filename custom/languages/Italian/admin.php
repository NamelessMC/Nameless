...
$language = [
    ...
    'module_outdated' => 'Abbiamo rilevato che questo modulo è per la versione {{intendedVersion}} di Nameless, ma tu stai usando la {{actualVersion}}',
    ...
    'default_template_set' => 'Modello predefinito impostato su {{template}} con successo.',
    ...
    'editing_template_file_in_template' => 'Modifica del file {{file}} nel modello {{template}}',
    ...
    'confirm_user_deletion' => "Sei sicuro di voler eliminare l'utente {{user}}?",
    ...
    'confirm_group_deletion' => 'Sei sicuro di voler eliminare il gruppo {{group}}?',
    ...
    'sitemap_last_generated_x' => "La sitemap è stata generata l'ultima volta {{generatedAt}}",
