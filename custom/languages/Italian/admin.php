...
$language = [
    ...
    'x_directory_not_writable' => 'La directory <strong>{x}</strong> non è scrivibile!',
    ...
    'editing_template_x' => 'Modifica modello {x}',
    ...
    // Updates
    'update' => 'Aggiorna',
    'current_version_x' => 'Versione corrente: <strong>{x}</strong>',
    'new_version_x' => 'Nuova versione: <strong>{x}</strong>',
    ...
    'editing_widget_x' => 'Modifica del widget {x}',
    'module_x' => 'Modulo: {x}',
    ...
    'editing_page_x' => 'Modifica pagina {x}',
    ...
    'confirm_leave_site' => 'Stai per lasciare questo sito! Sei sicuro di voler visitare <strong id="leaveSiteURL">{x}</strong>?', and make sure it has the id leaveSiteURL
