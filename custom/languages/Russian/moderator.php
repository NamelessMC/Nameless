...
$language = [
    ...
    '1_account_with_ip' => 'Найден 1 аккаунт с IP {{address}}', // Don't replace "{y}"
    'count_accounts_with_ip' => 'Найдено {{count}} аккаунтов с IP {{address}}', // Don't replace "{x}" or "{y}"
    '1_ip_with_name' => 'Найден 1 IP-адрес у пользователя {{user}}', // Don't replace "{y}"
    'count_ips_with_name' => 'Найдено {{count}} IP-адресов у пользователя {{user}}', // Don't replace "{x}" or "{y}"
    ...
    '1_open_report' => 'Сейчас 1 открытая жалоба.',
    'open_reports' => 'Сейчас {{count}} открытых жалоб.',
    ...
    'website' => 'Вебсайт',
    'ingame' => 'Игра',
    'x_closed_report' => '{{user}} закрыл эту жалобу.',
    'x_reopened_report' => '{{user}} переоткрыл эту жалобу.',
    ...
    'warn' => 'Предупреждение',
    'ban_ip' => 'Бан по IP',
    'viewing_user_x' => 'Просмотр пользователя {{user}}',
    ...
    'user_punished_alert' => '{{staffUser}} наказал пользователя {{user}}',
    'revoke' => 'Отменить',
    'revoked' => 'Отменено',
