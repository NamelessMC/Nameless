...
$language = array(
    ...
    'pre-release_warning' => 'Обратите внимание, что этот предварительный выпуск не предназначен для использования на общедоступном сайте.',
    'installer_information' => 'Установщик проведет вас через весь процесс установки.',
    'new_installation_question' => 'Во-первых, это новая установка?',
