...
$language = array(
    ...
    'discord_id_length' => 'Bitte stelle sicher, dass Deine Discord ID 18 Zeichen lang ist.',
    'discord_id_numeric' => 'Bitte stelle sicher, dass Deine Discord ID numerisch ist (nur Zahlen)..',
    'discord_invite_info' => 'To invite the Nameless Link bot to your Discord server, click <a target="_blank" href="https://namelessmc.com/discord-bot-invite">here</a>. Then, run the <code>/apiurl</code> command to link the bot with your website. Alternatively, you can <a target="_blank" href="https://github.com/NamelessMC/Nameless-Link/wiki/Own-instance">host the bot yourself</a>.',
    'discord_bot_must_be_setup' => 'Die Discord-Integration kann erst aktiviert werden, wenn Du den Bot eingerichtet hast. Für Informationen klicke bitte <a href="https://github.com/NamelessMC/Nameless-Link/wiki/Setup" target="_blank">hier</a>.',
    ...
    'confirm_email_error_deletion' => 'Bist du sicher, dass Du diesen Fehler löschen willst?',
    ...
    'enable_mailer_help' => 'Aktiviere dies, wenn E-Mails standardmäßig nicht gesendet werden. Die Verwendung von PHPMailer erfordert, dass Du einen Dienst hast, der in der Lage ist, E-Mails an einen SMTP-Provider zu senden wie zum Beispiel Gmail oder GMX.',
    ...
    'email_language_info' => 'Du siehst Deine Sprache nicht? Stelle sicher, dass sich \'email.php\' in Deinem Sprachverzeichnis befindet und von Deinem Webserver beschreibbar ist.',
    'editing_language' => 'Sprache bearbeiten',
    'email_preview_popup' => 'Vorschau',
    'email_preview_popup_message' => 'Klicke hier, um eine Vorschau der E-Mail anzuzeigen.',
    ...
    'terms_error' => 'Bitte stelle sicher, dass Deine Geschäftsbedingungen nicht länger als 100000 Zeichen sind.',
    ...
    'navbar_order_instructions' => 'Du kannst jedem Artikel eine Zahl über 0 geben, um Artikel in der Navigationsleiste zu ordnen, wobei 1 der erste Artikel ist und höhere Zahlen danach.',
    'navbar_icon' => 'Navbar Icon',
    'navbar_icon_instructions' => 'Du kannst hier auch jedem Navigationsleistenelement ein Symbol hinzufügen, z. B. mithilfe von <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" rel="noopener nofollow">Font Awesome</a>, <a href="https://semantic-ui.com/elements/icon.html" target="_blank" rel="noopener nofollow">Semantic UI</a>.',
    ...
    'confirm_delete_reaction' => 'Möchtest Du diese Reaktion wirklich löschen?',
    ...
    'enter_authme_db_details' => 'Bitte gebe gültige Datenbank Informationen ein.',
    ...
    'external_query_help' => 'Wenn die Standard-Serverabfrage nicht funktioniert, aktiviere diese Option.',
    ...
    'server_name_required' => 'Bitte gebe den Servernamen ein',
    'server_name_minimum' => 'Bitte stelle sicher, dass Dein Servername mindestens 1 Zeichen hat',
    'server_name_maximum' => 'Bitte stelle sicher, dass Dein Servername maximal 20 Zeichen hat',
    'server_address_required' => 'Bitte gebe die Serveradresse ein',
    'server_address_minimum' => 'Bitte stelle sicher, dass Deine Serveradresse mindestens 1 Zeichen hat',
    'server_address_maximum' => 'Bitte stelle sicher, dass Deine Serveradresse maximal 64 Zeichen beträgt',
    'server_port_required' => 'Bitte gebe den Server Port ein',
    'server_port_minimum' => 'Bitte stelle sicher, dass Dein Server Port mindestens 2 Zeichen beträgt',
    'server_port_maximum' => 'Bitte stelle sicher, dass Dein ServerPort maximal 5 Zeichen beträgt',
    'server_parent_required' => 'Bitte wähle einen übergeordneten Server aus',
    'query_port_maximum' => 'Bitte stelle sicher, dass Dein Abfrage Port maximal 5 Zeichen beträgt',
    'server_created' => 'Server erfolgreich erstellt.',
    'confirm_delete_server' => 'Bist Du sicher, dass Du diesen Server löschen möchtest?',
    ...
    'leave_port_empty_for_srv' => 'Du kannst den Port leer lass, wenn dieser 25565 ist oder ob Deine Domain einen SRV-Record verwendet',
    'viewing_query_error' => 'Abfragefehler anzeigen',
    'confirm_query_error_deletion' => 'Bist Du sicher, dass Du diesen Abfragefehler löschen möchtest?',
    ...
    'mcassoc_instance_help' => '<a href="#" onclick="generateInstance();">Klicke hier, um einen Instanzschlüssel zu generieren</a>',
    'mcassoc_error' => 'Bitte stelle sicher, dass Deinen gemeinsamen Schlüssel korrekt eingegeben und einen Instanzschlüssel richtig erstellt hast.',
    ...
    'player_count_cronjob_info' => 'Du kannst einen Cron-Job einrichten, um Deine Server alle {x} Minuten mit dem folgenden Befehl abzufragen:',
    ...
    'banner_updated_successfully' => 'Banner erfolgreich aktualisiert. Es kann eine Weile dauern, bis Deine Änderungen wirksam werden.',
    ...
    'template_not_supported' => 'Ab NamelessMC 2.0.0-pr8 wird die Standardvorlage nicht unterstützt. Verwende für die beste Erfahrung eine unterstützte Vorlage.',
    'active' => 'Aktiv',
    ...
    'confirm_delete_template' => 'Bist Du sicher, dass Du diese Vorlage löschen möchtest?',
    'delete' => 'Löschen',
    ...
    'cant_write_to_template' => 'Kann nicht in Vorlagendatei schreiben! Bitte überprüfe die Dateiberechtigungen.',
    'unable_to_delete_template' => 'Vorlage kann nicht vollständig gelöscht werden. Bitte überprüfe die Dateiberechtigungen.',
    ...
    'background_image_info' => 'Bitte beachte, dass diese Option möglicherweise nicht mit den meisten Vorlagen kompatibel ist.',
    'dark_mode' => 'Dark Mode',
    ...
    'unable_to_delete_group' => 'Eine Standardgruppe oder eine Gruppe, die StaffCP anzeigen kann, kann nicht gelöscht werden. Bitte aktualisiere zuerst die Gruppeneinstellungen!',
    ...
    'force_tfa_warning' => 'Bitte stelle sicher, dass Dui wießt, was dies bewirkt, da Du sonst riskierst, dich selbst und alle Gruppenmitglieder auszusperren.',
    'force_tfa_alert' => 'Für Deine Gruppe muss die Zwei-Faktor-Authentifizierung aktiviert sein.',
    ...
    'cant_edit_this_group' => 'Du kannst die Gruppenberechtigungen nicht verändern!',
    ...
    'maintenance_message_max_1024' => 'Bitte stelle sicher, dass Deine Wartungsnachricht maximal 1024 Zeichen beträgt.',
    ...
    'new_urgent_update_available' => 'Es ist ein neues dringendes Update verfügbar. Bitte aktualisiere so schnell wie möglich!',
    ...
    'unsafe_html_warning' => 'Wenn Du diese Option aktivierst, kann jeder HTML-Code auf der Seite verwendet werden, einschließlich potenziell gefährlichem JavaScript. Aktiviere dies nur, wenn Du sicher bist, dass Dein HTML-Code sicher ist.',
    ...
    'confirm_delete_page' => 'Möchtest Du diese Seite wirklich löschen?',
    ...
    'api_info' => 'Die API ermöglicht es Plugins und anderen Diensten, mit Deiner Website zu interagieren, wie zum Beispiel das <a href="https://plugin.namelessmc.com" target="_blank"> offizielle Nameless-Plugin</a>.',
    'enable_legacy_api' => 'Legacy-API aktivieren',
    'legacy_api_info' => 'Die Legacy-API ermöglicht Plug-ins, die die alte Nameless version 1 API verwenden, um mit Deiner Version 2-Website zu arbeiten.',
    'confirm_api_regen' => 'Bist Du sicher, dass Du deinen API-Schlüssel neu generieren möchtest?',
    'api_key' => 'API Key',
    'api_url' => 'API URL',
    'copy' => 'Copy',
    ...
    'group_sync_info' => 'Du kannst die API so konfigurieren, dass die Website-Gruppe eines Benutzers automatisch aktualisiert wird, wenn seine Integrationsgruppe geändert wird. Gebe einfach den Namen / die ID der Integrationsgruppe und die Website-Gruppe ein, mit der sie synchronisiert werden soll.',
    ...
    'api_endpoints_info' => 'Mit API-Endpunkten können Module Möglichkeiten für externe Anwendungen (wie Minecraft und Discord) erstellen, um mit Deiner NamelessMC-Website zu interagieren.',
    'route' => 'Route',
    ...
    'delete_hook' => 'Möchtest Du diesen Hook wirklich löschen?',
    ...
    'confirm_leave_site' => 'Du bist im Begriff, diese Seite zu verlassen! Möchtest Du <strong id="leaveSiteURL">{x}</strong>unbedingt besuchen??', // don't replace {x} and make sure it has the id leaveSiteURL
    ...
    'announcement_info' => 'Erstelle Ankündigungen, um eine Nachricht für bestimmte Gruppen auf bestimmten Seiten Deiner Website anzuzeigen.',
    ...
    'discord_settings_updated' => 'Deine Discord-Einstellungen wurden erfolgreich aktualisiert.',
    'discord_guild_id_required' => 'Bitte gebe Deine Discord Server ID ein, damit die Discord-Integration funktioniert.',
    'discord_bot_url' => 'Discord Bot URL',
    'discord_bot_url_info' => 'Der Speicherort Deiner benutzerdefinierten Instanz des Nameless Link-Bots. Änder diesen Wert nur, wenn Du weisst, was Du tust!',
    'discord_bot_url_required' => 'Bitte gebe Deine Bot-URL ein, damit die Discord-Integration funktioniert.',
    'discord_invalid_api_url' => 'Deine API-URL hat sich anscheinend geändert. Bitte lasse den Inhaber oder einen Admin die URL mit dem Nameless Link-Bot aktualisieren.',
    'test_bot_url' => 'Teste die Bot-URL',
    'discord_bot_url_valid' => 'Deine Bot-URL ist gültig.',
