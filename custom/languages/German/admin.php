...
$language = [
    ...
    'navbar_icon_instructions' => 'Du kannst hier auch jedem Navigationsleistenelement ein Symbol hinzufügen, z. B. mithilfe von <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" rel="noopener nofollow">Font Awesome</a>, <a href="https://fomantic-ui.com/elements/icon.html" target="_blank" rel="noopener nofollow">Fomantic UI</a>.',
    ...
    'announcement_icon_instructions' => 'Du kannst hier auch jeder Ankündigung ein Symbol hinzufügen, z. B. <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" rel="noopener nofollow">Font Awesome</a>, <a href="https://fomantic-ui.com/elements/icon.html" target="_blank" rel="noopener nofollow">Fomantic UI</a>.',
    'header' => 'Kopfzeile',
    'message' => 'Nachricht',
    ...
    'editing_integration_for_x' => 'Bearbeitung der {{integration}} Integration für {{user}}', // Don't replace {integration} and {user}
    'linking_integration_for_x' => 'Verlinkung der {{integration}} Integration für {{user}}', // Don't replace {integration} and {user}
    ...
    'link_account_success' => '{{user}} hat sein {{integration}}-Konto erfolgreich verknüpft.', // Don't replace {user} and {integration}
