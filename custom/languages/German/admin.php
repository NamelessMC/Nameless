...
$language = [
    ...
    // Overview
    'running_nameless_version' => 'Forum läuft auf der Version {{version}}',
    'running_php_version' => 'Laufende PHP version {{version}}',
    ...
    'send_test_email_info' => 'Die folgende Schaltfläche versucht, eine E-Mail an Deine E-Mail-Adresse zu senden, <strong> {x} </strong>. Falls Irgendwelche Fehler, die beim Senden der E-Mail enstehen, werden angezeigt.',
    'send' => 'Senden',
    ...
    'captcha_general' => 'Captcha aktivieren?',
    'captcha_login' => 'Captcha beim Login aktivieren?',
    'captcha_type' => 'Captcha Type',
    'captcha_site_key' => 'Captcha-Websiteschlüssel',
    ...
    'unable_to_enable_module_dependencies' => 'Modul kann nicht aktiviert werden, da dies vom Modul {x} abhängt, das nicht aktiviert ist.',
    'unable_to_disable_module' => 'Modul kann nicht deaktiviert werden - das Modul {x} hängt davon ab.',
    ...
    'default_template_set' => 'Die Vorlage {x} wurde als Standard gesetzt.',
    'template_deactivated' => 'Vorlage wurde deaktiviert.',
    'template_activated' => 'Vorlage wurde aktiviert.',
    'permissions' => 'Berechtigungen',
    'setting_perms_for_x' => 'Festlegen von Berechtigungen für Vorlage {x}',
    ...
    'background_image_x' => 'Hintergrundbild: <strong>{x}</strong>',
    'banner_image_x' => 'Banner image: <strong>{x}</strong>',
    'logo_image_x' => 'Logo image: <strong>{x}</strong>',
    'favicon_image_x' => 'Favicon image: <strong>{x}</strong>',
    'x_directory_not_writable' => 'The {{directory}} directory is not writable!',
    ...
    'editing_template_x' => 'Template {{template}} bearbeiten',
    'editing_template_file_in_template' => 'Bearbeiten der Datei{x} im Template {y}',
    ...
    'confirm_user_deletion' => 'Willst du den Benutzer <strong>{x}</strong> wirklich löschen?',
    ...
    'confirm_group_deletion' => 'Möchtest du die Gruppe {x} wirklich löschen?',
    ...
    'editing_user_x' => 'Benutzer bearbeiten {x}',
    'details' => 'Details',
    ...
    'signed_in_as_x' => 'Eingeloggt als {x}',
    'warning' => 'Warnung',
    ...
    'template_changes' => 'Vorlagen Bearbeitungen',
    'email_logs' => 'E-Mail Logs',
    'discord_logs' => 'Discord Logs',
    'group_sync_logs' => 'Gruppensync Logs',
    ...
    // Updates
    'update' => 'Update',
    'current_version_x' => 'Aktuelle Version: {{version}}',
    'new_version_x' => 'Neue Version: {{version}}',
    ...
    'editing_widget_x' => 'Bearbeite Widget {{widget}}',
    'module_x' => 'Modul: {{module}}',
    ...
    'editing_page_x' => 'Seite bearbeiten {{page}}',
    ...
    'link_to_complete_registration' => 'Link zur vollständigen Registrierung: {x}',
    ...
    'group_sync_plugin_not_set_up' => 'Plugin nicht aufgesetzt',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Die Sitemap-Datei {x} konnte nicht geladen werden',
    ...
    'sitemap_last_generated_x' => 'Letzte Sitemap wurde erstellt {x}',

    // Page metadata
    'page_metadata' => 'Seiten Metadaten',
    'metadata_page_x' => 'Anzeigen von Metadaten für Seite {x}',
    'keywords' => 'Keywörter',
    ...
    'unlink_account_success' => 'Erfolgreich ihr Konto von {x} entkoppelt.',
];
