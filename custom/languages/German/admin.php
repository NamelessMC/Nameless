...
$language = [
    ...
    'send_test_email_info' => 'Die folgende Schaltfläche versucht, eine E-Mail an Deine E-Mail-Adresse zu senden, {{email}}. Falls Irgendwelche Fehler, die beim Senden der E-Mail enstehen, werden angezeigt.',
    'send' => 'Senden',
    ...
    'module_outdated' => 'Wir haben festgestellt, dass dieses Modul für die Nameless Version {{intendedVersion}}, vorgesehen ist, aber Du führst die Nameless Version {{actualVersion}} aus',
    ...
    'unable_to_enable_module_dependencies' => 'Modul kann nicht aktiviert werden, da dies vom Modul {{module}} abhängt, das nicht aktiviert ist.',
    'unable_to_disable_module' => 'Modul kann nicht deaktiviert werden - das Modul {{module}} hängt davon ab.',
    ...
    'default_template_set' => 'Die Vorlage {{template}} wurde als Standard gesetzt.',
    ...
    'background_image_x' => 'Hintergrundbild: {{imageName}}',
    'banner_image_x' => 'Banner image: {{imageName}}',
    ...
    'editing_template_file_in_template' => 'Bearbeiten der Datei {{file}} im Template {{template}}',
    ...
    'confirm_user_deletion' => 'Willst du den Benutzer {{user}} wirklich löschen?',
    ...
    'confirm_group_deletion' => 'Möchtest du die Gruppe {{group}} wirklich löschen?',
    ...
    'editing_user_x' => 'Benutzer bearbeiten {{user}}',
    'details' => 'Details',
    ...
    // Sitemap
    'unable_to_load_sitemap_file_x' => 'Die Sitemap-Datei {{file}} konnte nicht geladen werden',
    ...
    'sitemap_last_generated_x' => 'Letzte Sitemap wurde erstellt {{generatedAt}}',
    ...
    'confirm_leave_site' => 'Du bist im Begriff, diese Seite zu verlassen! Möchtest Du {{link}} unbedingt besuchen??',
    ...
    'unlink_account_success' => 'Erfolgreich ihr Konto von {{provider}} entkoppelt.',
];
