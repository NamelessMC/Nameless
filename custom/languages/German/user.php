...
$language = [
    ...
    // Profile settings
    'field_is_required' => '{{field}} wird benötigt.',
    ...
    'post_on_wall' => 'Nachricht auf {{user}}\'s Profilseite posten.',
    ...
    'registered_x' => 'Mitglied seit: {{registeredAt}}',
    'last_seen' => 'Zuletzt gesehen:',
    'last_seen_x' => 'Zuletzt gesehen: {{lastSeenAt}}',
    'new_wall_post' => '{{author}} hat etwas in deine Pinnwand geschrieben.',
    ...
    'new_wall_post_reply' => '{{author}} hat auf deinen Beitrag im Profil von {{user}} geantwortet.',
