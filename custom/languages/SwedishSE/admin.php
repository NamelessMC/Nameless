...
$language = [
    ...
    'module_outdated' => 'Vi har upptäckt att den här modulen är avsedd för Nameless version {{intendedVersion}}, men du kör Nameless version {{actualVersion}}',
    ...
    'background_image_x' => 'Bakgrundsbild: {{imageName}}',
    'banner_image_x' => 'Bannerbild: {{imageName}}',
    'logo_image_x' => 'Logotypbild: {{imageName}}',
    'favicon_image_x' => 'Favicon-bild: {{imageName}}',
    ...
    'editing_template_file_in_template' => 'Redigera fil {{file}} i mall {{template}}',
