...
$language = [
    ...
    'send_test_email_info' => 'Följande knapp kommer att försöka skicka ett mail till din e-postadress, <strong> {x} </strong>. Eventuella fel när du skickar e-postmeddelandet visas.',
    'send' => 'Skicka',
    ...
    'unable_to_enable_module_dependencies' => 'Det går inte att aktivera modulen eftersom det behöver modulen {x}, som inte är aktiverad.',
    'unable_to_disable_module' => 'Det går inte att inaktivera modulen - modulen {x} behöver den',
    ...
    'default_template_set' => 'Standard mallen är nu {x}!',
    'template_deactivated' => 'Mallen är nu deaktiverad!',
    'template_activated' => 'Mallen har blivit aktiverat!',
    'permissions' => 'Behörigheter',
    'setting_perms_for_x' => 'Inställer behörigheter för mall {x}',
    ...
    'confirm_user_deletion' => 'Är du säker på att du vill radera användaren <strong>{x}</strong>?',
    ...
    'confirm_group_deletion' => 'Är du säker på att du vill ta bort gruppen {x}?',
    ...
    'link_to_complete_registration' => 'Länk till fullständig registrering: {x}',
    ...
    'sitemap_last_generated_x' => 'Sitemap genererades senast {x}',
