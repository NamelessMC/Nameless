...
$language = [
    ...
    // Overview
    'running_nameless_version' => 'Kör NamelessMC version {{version}}',
    'running_php_version' => 'Kör PHP version {{version}}',
    ...
    'send_test_email_info' => 'Följande knapp kommer att försöka skicka ett mail till din e-postadress, {{email}}. Eventuella fel när du skickar e-postmeddelandet visas.',
    'send' => 'Skicka',
    ...
    'module_outdated' => 'Vi har upptäckt att den här modulen är avsedd för Nameless version {x}, men du kör Nameless version {y}',
    ...
    'unable_to_enable_module_dependencies' => 'Det går inte att aktivera modulen eftersom det behöver modulen {{module}}, som inte är aktiverad.',
    'unable_to_disable_module' => 'Det går inte att inaktivera modulen - modulen {{module}} behöver den',

    // Styles
    'templates' => 'Mallar',
    'panel_templates' => 'Panel Mallar',
    'view_all_panel_templates' => 'Visa alla panel mallar',
    'template_outdated' => 'Vi har upptäckt att din mall är för Nameless version {{intendedVersion}}, men du kör Nameless version {{actualVersion}}',
    ...
    'default_template_set' => 'Standard mallen är nu {{template}}!',
    ...
    'background_image_x' => 'Bakgrundsbild: {{imageName}}', // Byt inte ut {x}
    'banner_image_x' => 'Bannerbild: {{imageName}}', // Byt inte ut {x}
    'logo_image_x' => 'Logotypbild: {{imageName}}', // Byt inte ut {x}
    'favicon_image_x' => 'Favicon-bild: {{imageName}}', // Byt inte ut {x}
    'x_directory_not_writable' => 'Katalogen {{directory}} är inte skrivbar!',
    ...
    'template' => 'Mall',
    'stats' => 'Statistik',
    'downloads_x' => 'Nedladdningar: {{downloads}}',
    'views_x' => 'Visningar: {{views}}',
    'rating_x' => 'Betyg: {{rating}}',
    'editing_template_x' => 'Redigeringsmall {{template}}',
    'editing_template_file_in_template' => 'Redigera fil {{file}} i mall {{template}}', // Byt inte ut {x} eller {y}
    ...
    'confirm_user_deletion' => 'Är du säker på att du vill radera användaren {{user}}?',
    ...
    'confirm_group_deletion' => 'Är du säker på att du vill ta bort gruppen {{group}}?',
    ...
    'editing_user_x' => 'Redigerar användare {{user}}',
    'details' => 'Detaljer',
    ...
    // Updates
    'update' => 'Uppdatera',
    'current_version_x' => 'Nuvarande version: {{version}}',
    'new_version_x' => 'Ny version: {{version}}',
    ...
    'editing_widget_x' => 'Redigerar widget {{widget}}',
    ...
    'view_page' => 'Visa Sida?',
    'editing_page_x' => 'Redigerar Sidan {{page}}',
    ...
    'sitemap_last_generated_x' => 'Sitemap genererades senast {{generatedAt}}',
