...
$language = [
    ...
    // Profile settings
    'field_is_required' => 'Câmpul "{{field}}" este necesar.',
    ...
    'new_wall_post' => '{{author}} a postat pe peretele tău.',
    ...
    'post_on_wall' => 'Postați pe peretele lui {{user}}',
    ...
    'registered_x' => 'Înregistrat: {{registeredAt}}',
    'last_seen' => 'Vazut ultima data:',
    'last_seen_x' => 'Vazut ultima data: {{lastSeenAt}}',
    ...
    'confirm_block_user' => 'Sigur doriți să blocați acest utilizator? Nu va mai putea să vă trimită mesaje private sau să vă eticheteze în postări.',
    ...
    'new_wall_post_reply' => '{{author}} a răspuns la postarea ta pe profilul lui {{user}}.',
