...
$language = [
    ...
    'send_test_email_info' => 'Următorul buton va încerca să trimită un e-mail la adresa dvs. de e-mail, <strong>{x}</strong>. Orice erori întâmpinate în timp ce trimiteți e-mailul vor fi afișate.',
    'send' => 'Trimite',
    ...
    'default_template_set' => 'Șablonul prestabilit a fost setat la {x} cu succes.',
    'template_deactivated' => 'Șablonul a fost dezactivat.',
    'template_activated' => 'Șablonul a fost activat.',
    'permissions' => 'Permisiuni',
    'setting_perms_for_x' => 'Setați permisiunile pentru șablonul {x}',
    ...
    'x_directory_not_writable' => 'Directorul <strong>{x}</strong> nu poate fi scris!',
    ...
    'editing_template_x' => 'Editare șablon: {x}',
    ...
    'confirm_user_deletion' => 'Sigur doriți să ștergeți utilizatorul <strong>{x}</strong>?',
    ...
    'confirm_group_deletion' => 'Sigur doriți să ștergeți grupul {x}?',
    ...
    'new_version_x' => 'Versiune nouă: <strong>{x}</strong>',
    ...
    'editing_widget_x' => 'Modificare piesă: {{widget}}',
    'module_x' => 'Module: {x}',
    ...
    'editing_page_x' => 'Editare pagină: {x}',
    ...
    'link_to_complete_registration' => 'Adresa pentru finalizarea înregistrări:',
    ...
    'sitemap_last_generated_x' => 'Harta site-ului a fost generată: {x}',
