...
$language = [
    ...
    'send_test_email_info' => 'Următorul buton va încerca să trimită un e-mail la adresa dvs. de e-mail, {{email}}. Orice erori întâmpinate în timp ce trimiteți e-mailul vor fi afișate.',
    'send' => 'Trimite',
    ...
    'new_field' => 'Adăugați un câmp nou',
    'required' => 'Necesar',
    'editable' => 'Editabil',
    'public' => 'Public',
    ...
    'module_outdated' => 'Am descoperit că acest modul este destinat pentru Nameless versiunea {{intendedVersion}}, dar utilizati Nameless versiunea {{actualVersion}}',
    ...
    'default_template_set' => 'Șablonul prestabilit a fost setat la {{template}} cu succes.',
    ...
    'editing_template_file_in_template' => 'Editare fișier {{file}} din șablonul {{template}}',
    ...
    'confirm_user_deletion' => 'Sigur doriți să ștergeți utilizatorul {{user}}?',
    ...
    'confirm_group_deletion' => 'Sigur doriți să ștergeți grupul {{group}}?',
    ...
    // Updates
    'update' => 'Actualizare',
    'current_version_x' => 'Versiune curentă: {{version}}',
    'new_version_x' => 'Versiune nouă: {{version}}',
    ...
    'editing_page_x' => 'Editare pagină: {{page}}',
    ...
    'sitemap_last_generated_x' => 'Harta site-ului a fost generată: {{generatedAt}}',
    ...
    'confirm_leave_site' => 'Sunteți pe cale să părăsiți acest site! Sunteți sigur că doriți să vizitați {{link}}?',
