                                                ...
                                                <tr data-id="{$server.id}">
                                                    ...
                                                    <td>
                                                        <div class="float-md-right">
                                                            <div class="btn btn-secondary"><i class="fas fa-arrows-alt"></i>
                                                            </div>
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group custom-control custom-switch">
                                    ...
                                    <input id="inputExternalQuery" name="external_query" type="checkbox"
                                        ...
                                        {if $EXTERNAL_QUERY_VALUE} checked{/if} />
                                    <label for="inputExternalQuery" class="custom-control-label">
                                        {$EXTERNAL_QUERY} <span class="badge badge-info"><i
                                ...
                                <div class="form-group custom-control custom-switch">
                                    ...
                                    <input id="inputStatusPage" name="status_page" type="checkbox"
                                        class="custom-control-input js-check-change" value="1" {if $STATUS_PAGE_VALUE}
                                        checked{/if} />
