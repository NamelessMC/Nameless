                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group custom-control custom-switch">
                                ...
                                <input id="inputBungeeInstance" name="bungee_instance" type="checkbox"
                                       class="custom-control-input" value="1" {if $BUNGEE_INSTANCE_VALUE} checked{/if}/>
                                <label for="inputBungeeInstance" class="custom-control-label">
                                    {$BUNGEE_INSTANCE} <span class="badge badge-info"><i class="fa fa-question-circle"
                                                                                         data-container="body"
                                                                                         data-toggle="popover"
                                                                                         data-placement="top"
                                                                                         title="{$INFO}"
                            ...
                            <div class="form-group custom-control custom-switch">
                                ...
                                <input id="inputStatusQueryEnabled" name="status_query_enabled" type="checkbox"
                                       ...
                                       value="1" {if $ENABLE_STATUS_QUERY_VALUE} checked{/if}/>
                            ...
                            <div class="form-group custom-control custom-switch">
                                ...
                                <input id="inputShowIPOnStatus" name="show_ip_enabled" type="checkbox"
                                       class="custom-control-input"
                                       value="1" {if $SHOW_IP_ON_STATUS_PAGE_VALUE} checked{/if}/>
                            ...
                            <div class="form-group custom-control custom-switch">
                                ...
                                <input id="inputQueryEnabled" name="query_enabled" type="checkbox"
                                       class="custom-control-input"
                                       value="1" {if $ENABLE_PLAYER_LIST_VALUE} checked{/if}/>
