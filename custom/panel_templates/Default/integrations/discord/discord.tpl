                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                                <label for="inputDiscordId">{$DISCORD_GUILD_ID} <span class="fa fa-question-circle" data-toggle="popover" data-title="{$INFO}" data-content="{$ID_INFO|escape}"><i class="fa fa-question"></i></label>
