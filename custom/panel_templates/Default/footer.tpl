    ...
    <ul class="nav nav-pills">
        <li class="nav-item dropup">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="https://github.com/NamelessMC/Nameless" target="_blank"><i class="fa fa-github fa-fw"></i> {$SOURCE}</a>
                <a class="dropdown-item" href="https://namelessmc.com" target="_blank"><i class="fa fa-life-ring fa-fw"></i> {$SUPPORT}</a>
            </div>
        </li>
    </ul>
