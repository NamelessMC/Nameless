        ...
        <div class="d-flex">
            ...
            <div class="col-sm-5 mb-0">
                <div class="float-right">
                    <a class="ml-1" href="https://github.com/NamelessMC/Nameless" target="_blank" data-toggle="tooltip" data-placement="top" title="{$SOURCE}"><i class="fab fa-github fa-fw text-github"></i></a>
                    ...
                    <a class="ml-1" href="https://docs.namelessmc.com/troubleshooting/faq" target="_blank" data-toggle="tooltip" data-placement="top" title="FAQ"><i class="fas fa-info-circle fa-fw text-info"></i></a>
