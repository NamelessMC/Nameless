        ...
        <div class="d-flex">
            ...
            <div class="col-sm-5 mb-0">
                <div class="float-right">
                    ...
                    <a class="ml-1" href="https://discord.com/invite/3wzUeGjX?" target="_blank" data-toggle="tooltip" data-placement="top" title="Discord"><i class="fab fa-discord fa-fw text-discord"></i></a>
