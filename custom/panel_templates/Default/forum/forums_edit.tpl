                        ...
                        <form role="form" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="InputDescription"
                                          placeholder="{$FORUM_DESCRIPTION}" class="form-control"
                                          rows="3">{$FORUM_DESCRIPTION_VALUE}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="InputType" name="forum_type">
                                        <option value="forum" {if $FORUM_TYPE_VALUE=='forum' } selected{/if}>
                                            {$FORUM_TYPE_FORUM}</option>
                                        <option value="category" {if $FORUM_TYPE_VALUE=='category' } selected{/if}>
                                            {$FORUM_TYPE_CATEGORY}
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group custom-control custom-switch">
                                ...
                                <input id="InputDisplay" name="display" type="checkbox" class="custom-control-input"
                                       value="1" {if $DISPLAY_TOPICS_AS_NEWS_VALUE} checked{/if} />
                            ...
                            <div class="form-group custom-control custom-switch">
                                <input id="InputForumRedirect" name="redirect" type="checkbox"
                                       class="custom-control-input" value="1" {if $REDIRECT_FORUM_VALUE}
                                    checked{/if} />
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="hidden" name="perm-view-0" value="0"/><input
                                            ...
                                            isset($GUEST_PERMISSIONS->view) && $GUEST_PERMISSIONS->view eq
                                            1} checked{/if} />
                                        </td>
                                        <td></td>
                                        <td></td>
                                        ...
                                        <td><input type="hidden" name="perm-view_others-0" value="0"/><input
                                                    ...
                                                    id="Input-view_others-0" value="1" type="checkbox" {if
                                            isset($GUEST_PERMISSIONS->view_other_topics) &&
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="hidden" name="perm-edit_topic-{$group->id|escape}"
                                                       value="0"/><input onclick="colourUpdate(this);"
                                                                         ...
                                                                         value="1"
                                                                         type="checkbox" {if isset($group->edit_topic) &&
                                                $group->edit_topic eq 1} checked{/if} />
                                            </td>
                                            ...
                                            <td><input type="hidden" name="perm-view_others-{$group->id|escape}"
                                                       value="0"/><input onclick="colourUpdate(this);"
                                                                         ...
                                                                         value="1"
                                                                         type="checkbox" {if isset($group->view_other_topics) &&
                                                $group->view_other_topics eq 1} checked{/if} />
                                            </td>
                                            <td><input type="hidden" name="perm-moderate-{$group->id|escape}"
                                                       value="0"/><input onclick="colourUpdate(this);"
                                                                         ...
                                                                         value="1"
                                                                         type="checkbox" {if isset($group->moderate) && $group->moderate
                                                eq 1} checked{/if} />
                                            </td>
                                        </tr>
                                        <script>
...
<script type="text/javascript">
    ...
    function toggle(group) {
        document.getElementById('Input-view-' + group).checked = !document.getElementById('Input-view-' + group).checked;
        document.getElementById('Input-topic-' + group).checked = !document.getElementById('Input-topic-' + group).checked;
        document.getElementById('Input-edit_topic-' + group).checked = !document.getElementById('Input-edit_topic-' + group).checked;
        document.getElementById('Input-post-' + group).checked = !document.getElementById('Input-post-' + group).checked;
        document.getElementById('Input-view_others-' + group).checked = !document.getElementById('Input-view_others-' + group).checked;
        document.getElementById('Input-moderate-' + group).checked = !document.getElementById('Input-moderate-' + group).checked;
    ...
    function toggleAll(that) {
        const first = (($(that).parents('tr').find(':checkbox').first().is(':checked') !== true));
