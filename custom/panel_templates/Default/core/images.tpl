    ...
    <div id="wrapper">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            {if isset($BACKGROUNDS_NOT_WRITABLE)
                                || isset($TEMPLATE_BANNERS_DIRECTORY_NOT_WRITABLE)
                                || isset($LOGOS_DIRECTORY_NOT_WRITABLE)
                                || isset($FAVICONS_DIRECTORY_NOT_WRITABLE)
                                || isset($OG_IMAGES_DIRECTORY_NOT_WRITABLE)
                            }
                                <div class="alert alert-danger alert-dismissible">
                                    ...
                                    <ul>
                                        ...
                                        {if isset($OG_IMAGES_DIRECTORY_NOT_WRITABLE)}
                                            <li>{$OG_IMAGES_DIRECTORY_NOT_WRITABLE}</li>
                                        {/if}
                                    </ul>
                                </div>
                            {/if}
                            ...
                            <button class="btn btn-info" data-toggle="modal" data-target="#uploadLogoModal">{$UPLOAD_NEW_IMAGE}</button>
                            ...
                            <button class="btn btn-info" data-toggle="modal" data-target="#uploadFaviconModal">{$UPLOAD_NEW_IMAGE}</button>
                            ...
                            <a href="{$RESET_OG_IMAGE_LINK}" class="btn btn-danger">{$RESET_OG_IMAGE}</a>
                            <button class="btn btn-info" data-toggle="modal" data-target="#uploadOgImageModal">{$UPLOAD_NEW_IMAGE}</button>
        ...
        <div class="modal fade" id="uploadOgImageModal" tabindex="-1" role="dialog" aria-labelledby="uploadOgImageModal" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="uploadOgImageModalLabel">{$UPLOAD_NEW_IMAGE}</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="{$CLOSE}" onclick="location.reload();">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <!-- Upload modal -->
                        <form action="{$UPLOAD_PATH}" class="dropzone" id="uploadOgImageDropzone">
                            <input type="hidden" name="token" value="{$TOKEN}">
