                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" class="form-control" id="InputUsername" placeholder="{$USERNAME}" value="{$USERNAME_VALUE}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="InputVerified">{$VERIFIED}?</label>
                                <input type="hidden" name="verified" value="0">
                                <input id="InputVerified" name="verified" type="checkbox" class="js-switch" value="1" {if $VERIFIED_VALUE} checked{/if} />
                            </div>
                            <div class="form-group">
