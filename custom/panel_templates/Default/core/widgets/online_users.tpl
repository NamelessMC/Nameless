<form action="" method="post">
    <div class="form-group custom-control custom-switch">
        <input id="inputIncludeStaff" name="staff" type="checkbox" class="custom-control-input js-check-change"
    ...
    <div class="form-group custom-control custom-switch">
        <input id="inputShowNickname" name="nickname" type="checkbox" class="custom-control-input js-check-change"
