                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <textarea style="width:100%" rows="10" name="privacy" id="InputPrivacy">{$PRIVACY_POLICY_VALUE}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="InputTerms">{$TERMS_AND_CONDITIONS}</label>
                                    <textarea style="width:100%" rows="10" name="terms" id="InputTerms">{$TERMS_AND_CONDITIONS_VALUE}</textarea>
                                </div>
                                <div class="form-group">
