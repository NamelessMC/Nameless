                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="" method="post">
                            ...
                            <div class="form-group custom-control custom-switch">
                                ...
                                <label class="custom-control-label" for="InputTfa">{$FORCE_TFA} <span
                                            class="badge badge-warning" data-toggle="popover" data-title="{$WARNING}"
                                            data-content="{$FORCE_TFA_WARNING|escape}"><i
                                                class="fa fa-exclamation-triangle"></i></label>
                            </div>
                            <div class="form-group custom-control custom-switch">
                                <input type="hidden" name="staff" value="0">
                                <input type="checkbox" name="staff" class="custom-control-input" id="InputStaff"
                            ...
                            <div class="form-group custom-control custom-switch">
                                ...
                                <input type="checkbox" name="default" class="custom-control-input" id="InputDefault"
                                       value="1" {if $DEFAULT_GROUP_VALUE eq 1} checked{/if}>
                                <label class="custom-control-label" for="InputDefault">{$DEFAULT_GROUP}</label>
                            </div>
                            <div class="form-group">
