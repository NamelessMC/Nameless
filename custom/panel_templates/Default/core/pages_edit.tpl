                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <label for="inputUnsafeHTML">{$UNSAFE_HTML}</label> <span data-toggle="popover" data-content="{$UNSAFE_HTML_WARNING}" class="badge badge-warning"><i class="far fa-exclamation-triangle"></i></span>
