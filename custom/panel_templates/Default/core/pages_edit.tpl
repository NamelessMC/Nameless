                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="link_location" name="link_location">
                                    <option value="1" {if $PAGE_LINK_LOCATION_VALUE eq 1} selected{/if}>
                                        {$PAGE_LINK_NAVBAR}</option>
                                    <option value="2" {if $PAGE_LINK_LOCATION_VALUE eq 2} selected{/if}>
                                        {$PAGE_LINK_MORE}</option>
                                    <option value="3" {if $PAGE_LINK_LOCATION_VALUE eq 3} selected{/if}>
                                        {$PAGE_LINK_FOOTER}</option>
                                    <option value="4" {if $PAGE_LINK_LOCATION_VALUE eq 4} selected{/if}>
                                        {$PAGE_LINK_NONE}</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group custom-control custom-switch">
                                <input id="inputRedirect" name="redirect_page" type="checkbox"
                                       class="custom-control-input" {if $PAGE_REDIRECT_VALUE eq 1} checked{/if} />
                            ...
                            <div class="form-group custom-control custom-switch">
                                <input id="inputUnsafeHTML" name="unsafe_html" type="checkbox"
                                       class="custom-control-input" {if $UNSAFE_HTML_VALUE eq 1} checked{/if} />
                            ...
                            <table class="table table-responsive table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" name="perm-view-0" value="0"/><input
                                                ...
                                                value="1" type="checkbox" {if $GUEST_PERMS eq 1} checked{/if} />
                                    </td>
                                </tr>
