                            ...
                            <table class="table table-borderless table-striped">
                                ...
                                {foreach $INTEGRATIONS as $integration_name => $integration}
                                    <tr>
                                        ...
                                        <td>
                                            {if isset($USER_INTEGRATIONS[$integration_name]) && $USER_INTEGRATIONS[$integration_name].verified}
                                        ...
                                        <td class="text-right">
                                            {if isset($USER_INTEGRATIONS[$integration_name])}
                                                <button class="btn btn-danger btn-sm" onclick="showDeleteModal('{$integration_name}')">{$UNLINK}</button>
                                                <a href="{$integration.edit}" class="btn btn-warning btn-sm">{$EDIT}</a>
                                            {else}
                                                <a href="{$integration.link}" class="btn btn-success btn-sm">{$MANUAL_LINKING}</a>
                                            {/if}
                                        </td>
                                    </tr>
                                {/foreach}
