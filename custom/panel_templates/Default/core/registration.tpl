                        ...
                        <div class="row">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <div class="form-group custom-control custom-switch text-center">
                                            <input id="enable-discord" name="enable-discord" type="checkbox"
                                                class="custom-control-input" {if $DISCORD_OAUTH_ENABLED &&
                                                $DISCORD_OAUTH_SETUP} checked{/if} />
                                            <label for="enable-discord" id="enable-discord"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="client-id-discord" class="form-control"
                                                id="client-id-discord" placeholder="{$CLIENT_ID}"
                                                value="{$DISCORD_CLIENT_ID}">
                                        </div>

                                        <div class="form-group">
                                            <label for="client-secret-discord">Client Secret</label>
                                            <input type="password" name="client-secret-discord" class="form-control"
                                                id="client-secret-discord" placeholder="{$CLIENT_SECRET}"
                            ...
                            <div class="col">
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <div class="form-group custom-control custom-switch text-center">
                                            <input id="enable-google" name="enable-google" type="checkbox"
                                                class="custom-control-input" {if $GOOGLE_OAUTH_ENABLED &&
                                                $GOOGLE_OAUTH_SETUP} checked{/if} />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="client-id-google" class="form-control"
                                                id="client-id-google" placeholder="{$CLIENT_ID}"
                                                value="{$GOOGLE_CLIENT_ID}">
                                        </div>

                                        <div class="form-group">
                                            <label for="client-secret-google">Client Secret</label>
                                            <input type="password" name="client-secret-google" class="form-control"
                                                id="client-secret-google" placeholder="{$CLIENT_SECRET}"
