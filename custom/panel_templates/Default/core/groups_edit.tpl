                        ...
                        <div class="card-body">
                            ...
                            <form role="form" action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="groupname" class="form-control" id="InputGroupname" placeholder="{$NAME}" value="{$GROUP_NAME}">
                                </div>
                                <div class="form-group">
                                    <label for="InputHTML">{$GROUP_HTML}</label>
                                    <input type="text" name="html" class="form-control" id="InputHTML" placeholder="{$GROUP_HTML}" value="{$GROUP_HTML_VALUE}">
                                </div>
                                <div class="form-group">
                                    <label for="InputColour">{$GROUP_USERNAME_COLOUR}</label>
                                    <div class="input-group">
                                        <input type="text" name="username_style" class="form-control" id="InputColour" value="{$GROUP_USERNAME_COLOUR_VALUE}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username_css" class="form-control" id="InputCss" placeholder="{$GROUP_USERNAME_CSS}" value="{$GROUP_USERNAME_CSS_VALUE}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="tfa" class="js-switch" id="InputTfa" value="1" {if $FORCE_TFA_VALUE eq 1} checked{/if}>
                                </div>
                                <div class="form-group">
                                    <label for="InputStaff">{$STAFF_GROUP}</label>
                                    <input type="hidden" name="staff" value="0">
                                    <input type="checkbox" name="staff" class="js-switch" id="InputStaff" value="1" {if $STAFF_GROUP_VALUE eq 1} checked{/if}>
                                </div>
                                {if !isset($OWN_GROUP)}
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="default" class="js-switch" id="InputDefault" value="1" {if $DEFAULT_GROUP_VALUE eq 1} checked{/if}>
                                </div>
                                <div class="form-group">
