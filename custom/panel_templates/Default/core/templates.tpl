            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                                        ...
                                        <td>
                                            ...
                                            {if $template.default_warning}
                                                ...
                                                <button role="button" class="btn btn-sm btn-danger"
                                                        data-toggle="popover"
                                                        data-title="{$WARNING}"
                                                        data-content="{$template.default_warning}"><i
                                            ...
                                            <div class="float-md-right">
                                                ...
                                                {if $template.edit_link}
                                                    <a class="btn btn-primary btn-sm"
                                                       href="{$template.edit_link}">{$EDIT}</a>
                                                {/if}

                                                {if $template.settings_link}
                                                    <a class="btn btn-info btn-sm"
                                                       href="{$template.settings_link}">{$SETTINGS}</a>
                                                {/if}
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <a href="{$VIEW_ALL_TEMPLATES_LINK}" class="btn btn-primary"
                           target="_blank">{$VIEW_ALL_TEMPLATES} &raquo;</a>
...
<script type="text/javascript">
    ...
    const $star_rating = $('.star-rating.view .fa-star');

    const SetRatingStar = function (type = 0) {
        if (type === 0) {
