                        ...
                        <div class="card-header" style="border-radius: 10px" id="heading{$i}}">
                            <h5 class="mb-0">
                                <button class="btn btn-link btn-block btn-accordion" data-toggle="collapse"
                                    ...
                                    <span style="{$punishment.punished_style}"><img src="{$punishment.punished_avatar}"
                                            style="max-width:20px;max-height:20px;" class="rounded"
                                            alt="{$punishment.punished_username}" /> {$punishment.punished_nickname}</span>
                            ...
                            <div id="collapse{$i}" class="collapse text-center" aria-labelledby="heading{$i}"
                                data-parent="#accordion">
                                {$CREATED} <span data-toggle="tooltip"
                                    data-title="{$punishment.time_full}">{$punishment.time}</span><br />
                                {$STAFF} <span style="{$punishment.staff_style}">{$punishment.staff_nickname} <img
                                        src="{$punishment.staff_avatar}" style="max-width:20px;max-height:20px;" class="rounded"
                                        alt="{$punishment.staff_username}" /></span><br />
