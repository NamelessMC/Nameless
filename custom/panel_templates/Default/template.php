    ...
    class Default_Panel_Template extends TemplateBase {
        ...
        public function __construct(Smarty $smarty, Language $language) {
            ...
            $this->addCSSFiles([
				...
				'https://cdnjs.cloudflare.com/ajax/libs/bootstrap4-duallistbox/4.0.2/bootstrap-duallistbox.min.css' => []
            ]);
            ...
            $this->addJSFiles([
				...
				'https://cdnjs.cloudflare.com/ajax/libs/bootstrap4-duallistbox/4.0.2/jquery.bootstrap-duallistbox.min.js' => []
            ]);
