...
if (!class_exists('Default_Panel_Template')) {
    class Default_Panel_Template extends TemplateBase {
        ...
        public function __construct(Smarty $smarty, Language $language) {
            ...
            $this->addCSSFiles([
                (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Default/assets/plugins/fontawesome/css/all.min.css' => [],
            ...
            $this->addJSFiles([
                ...
                (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Default/assets/plugins/fontawesome/js/all.min.js' => [],
