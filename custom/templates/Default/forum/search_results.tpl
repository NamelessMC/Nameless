                ...
                {foreach from=$RESULTS item=result}
                    <div class="card">
                        ...
                        <div class="card-block">
                            {$result.content}
                            <hr />
                            <a href="{$result.post_author_profile}"><img class="rounded-circle" src="{$result.post_author_avatar}" /></a> <a href="{$result.post_author_profile}" style="{$result.post_author_style}">{$result.post_author}</a>
