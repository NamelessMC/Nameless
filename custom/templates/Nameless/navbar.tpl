    ...
    <div class="ui fluid container">
        <div class="ui secondary menu">
            ...
            <div class="right menu">
                <div class="item">
                    <a href="">
                        <img class="ui mini circular image" src="https://cravatar.eu/helmavatar/2f778755502c4fb7ae96493d6429e8f3/128.png" alt="Samerton">
                    </a>
                </div>
            </div>
        </div>
...
<div class="pusher">
    <div id="wrapper">
        <div class="ui secondary {$NAMELESS_NAVBAR_EXTRA_CLASSES} small menu" id="navbar">
