      ...
      {nocache}
          {if count($MESSAGES)}
            <table class="ui fixed single line selectable unstackable small padded res table">
              <thead>
              <tr>
                <th class="nine wide"><h5>{$MESSAGE_TITLE}</h5></th>
                <th class="seven wide"><h5>{$LAST_MESSAGE}</h5></th>
              </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <h5 class="ui image header">
                      ...
                      <div class="content">
                        <a href="{$message.last_message_user_profile}" style="{$message.last_message_user_style}"
                        ...
                        <div class="sub header" data-toggle="tooltip"
                             data-content="{$message.last_message_date_full}">{$message.last_message_date}</div>
                      </div>
                    </h5>
                  </td>
                </tr>
