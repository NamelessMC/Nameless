                        ...
                        {if (isset($LOGGED_IN_USER) && $reply.user_id !== $USER_ID || count($reply.post_reactions))}
                            <div class="ui mini info message" id="reactions">
                                ...
                                {if count($reply.post_reactions)}
                                    <div class="right floated" data-toggle="modal"
                                         data-target="#modal-reactions-{$reply.id}">
                                        {assign i 1}
            ...
            <div class="res right floated">
                ...
                {if isset($reply.buttons.edit)}
                    <a class="ui mini icon button" href="{$reply.buttons.edit.URL}"
                       data-tooltip="{$reply.buttons.edit.TEXT}"
                ...
                {if isset($reply.buttons.quote)}
                    <button class="ui mini icon button" onclick="quote({$reply.id})"
                            data-tooltip="{$reply.buttons.quote.TEXT}"
        ...
        <div class="ui stackable grid">
            <div class="ui row">
                <div class="ui five wide tablet three wide computer column" id="reply-sidebar">
                    <div style="text-align: center;">
                        <img class="ui small circular image" src="{$LOGGED_IN_USER.avatar}" alt="avatar"/>
                        <h3 class="ui header">
