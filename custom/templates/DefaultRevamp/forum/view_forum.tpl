                ...
                <div class="content">
                  ...
                  <div class="sub header">
                    <a href="{$subforum.latest_post.last_user_link}"
                      ...
                      style="{$subforum.latest_post.last_user_style}">{$subforum.latest_post.last_user}</a> &middot;
                ...
                <div class="content">
                  ...
                  <div class="sub header">
                    <a href="{$discussion.author_link}"
                      ...
                      style="{$discussion.topic_created_style}">{$discussion.topic_created_username}</a> &middot; <span
                      data-toggle="tooltip"
            ...
            <td>
              <h5 class="ui image header">
                ...
                <div class="content">
                  ...
                  <div class="sub header" data-toggle="tooltip" data-content="{$discussion.last_reply}">
