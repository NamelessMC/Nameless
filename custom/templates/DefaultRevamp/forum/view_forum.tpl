                                    ...
                                    {if !empty($subforum.latest_post)}
                                        <h5 class="ui header">
                                            <img class="ui mini circular image"
                                                 src="{$subforum.latest_post.last_user_avatar}">
                                            <div class="content">
                                                ...
                                                <div class="ui wide popup">
                                                    ...
                                                    <br/>{$BY|capitalize} <a
                                                            style="{$subforum.latest_post.last_user_style}"
                                    ...
                                    <div class="content">
                                        {if isset($discussion.labels) && count($discussion.labels)}
                                            {foreach from=$discussion.labels item=label}
                                                {$label}
                                            {/foreach}
                                        {/if} <a href="{$discussion.link}"
                                                 data-toggle="popup">{$discussion.topic_title}</a>
                                        <div class="ui wide popup">
