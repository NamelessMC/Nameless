  ...
  <div class="ui container">
    ...
    <div class="ui stackable padded grid" id="forum-index">
      <div class="ui centered row">
          ...
          {/if}
        <div
          class="ui {if count($WIDGETS_LEFT) && count($WIDGETS_RIGHT) }four wide tablet eight wide computer{elseif count($WIDGETS_LEFT) || count($WIDGETS_RIGHT)}ten wide tablet twelve wide computer{else}sixteen wide{/if} column">            {if isset($SPAM_INFO)}
