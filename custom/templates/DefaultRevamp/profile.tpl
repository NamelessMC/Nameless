          ...
          <div class="comment" id="post-{$post.id}">
            ...
            <div class="content">
              ...
              <div class="actions">
                ...
                <a href="{if $post.reactions_link !== " #"}{$post.reactions_link}{else}#{/if}" data-toggle="popup">Like
  ...
  <div class="content">
    ...
    <center>
      <form class="ui form" action="{$UPLOAD_BANNER_URL}" method="post" enctype="multipart/form-data" id="form-banner">
        ...
        <button type="submit" class="ui icon labeled primary button" type="submit"><i class="ui upload icon"></i>
          {$UPLOAD}</button>
      </form>
    </center>
    {/if}
