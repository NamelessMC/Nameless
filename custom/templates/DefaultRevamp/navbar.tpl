            ...
            <div class="ui container">
                        ...
                        <div class="ui dropdown item">
                            ...
                            <div class="menu">
                                ...
                                {foreach from=$item.items item=dropdown}
                                    ...
                                    {else}
                                        <a class="item" href="{$dropdown.link}"
                                           target="{$dropdown.target}">{$dropdown.icon}
                                            {$dropdown.title}</a>
                                    {/if}
                                {/foreach}
                            </div>
                ...
                <div class="right menu">
                    {foreach from=$USER_SECTION key=name item=item}
                                    ...
                                    {foreach from=$item.items item=dropdown}
                                        ...
                                        {else}
                                            {if isset($dropdown.action)}
                                                <a class="item" href="#" data-link="{$dropdown.link}"
                                                   data-action="{$dropdown.action}">
                        ...
                        {else}
                            {if ($name == "panel")}
                                <a class="ui small primary icon button" href="{$item.link}"
                                   target="{$item.target}">{$item.icon}</a>
                            {elseif ($name == "register")}
                                <a class="ui small primary button" href="{$item.link}"
                                   target="{$item.target}">{$item.title}</a>
                            {else}
                                <a class="ui small default button" href="{$item.link}"
                                   target="{$item.target}">{$item.title}</a>
                            {/if}
                        {/if}
                    {/foreach}
