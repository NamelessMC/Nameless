        ...
        <div class="ui segment">
            ...
            <div class="ui two cards">
                <?php foreach ($all_modules as $module => $description) { ?>
                    <div class="ui card fluid" data-module-name="<?php echo $module ?>" style="cursor: pointer; user-select: none; pointer-events: all !important; height: fit-content;" onclick="toggleModule(this)">
