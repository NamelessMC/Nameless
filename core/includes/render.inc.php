    ...
    <nav>
        <ul class="<?php echo implode(' ', $classes); ?>">
            ...
            <li class="page-item <?php echo implode(' ', $classes); ?>"><a class="page-link"
                                                                           href="<?php echo $href; ?>"><?php echo $previous; ?></a>
            </li>
            <?php
            /**
            ...
            if (!$clean) {
                ...
                for ($x = 1; $x < $leading; ++$x) {
                    ...
                    ?>
                    <li class="page-item number"><a class="page-link"
                                                    data-pagenumber="<?php echo($current + $x - $leading); ?>"
                                                    href="<?php echo $href; ?>"><?php echo($current + $x - $leading); ?></a>
                    </li>
                    <?php
                }
                ...
                // print current page
                ?>
                <li class="page-item number active"><a class="page-link" data-pagenumber="<?php echo $current; ?>"
                                                       href="#"><?php echo $current; ?></a></li>
                <?php
                ...
                if ($current != $max) {
                    ...
                    for ($x = 0; $x < $trailing; ++$x) {
                        ...
                        ?>
                        <li class="page-item number"><a class="page-link"
                                                        data-pagenumber="<?php echo($current + $x + 1); ?>"
                                                        href="<?php echo $href; ?>"><?php echo($current + $x + 1); ?></a>
                        </li>
                        <?php
                    }
                }
            ...
            ?>
            <li class="page-item <?php echo implode(' ', $classes); ?>"><a class="page-link"
                                                                           href="<?php echo $href; ?>"><?php echo $next; ?></a>
            </li>
        </ul>
    </nav>
    <?php
