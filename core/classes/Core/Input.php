...
class Input {
    ...
    public static function createTinyEditor(Language $language, string $name): string {
        ...
        tinymce.init({
          ...
          toolbar: \'undo redo | bold italic underline strikethrough formatselect fontsizeselect forecolor backcolor ltr rtl | alignleft aligncenter alignright alignjustify | codesample emoticons hr image link numlist bullist | spoiler-add spoiler-remove\',
