...
class Queries {
    ...
    public function dbInitialise(string $charset = 'latin1', string $engine = 'InnoDB') {
        ...
        $this->_db->createTable('users_profile_fields', ' `id` int(11) NOT NULL AUTO_INCREMENT, `user_id` int(11) NOT NULL, `field_id` int(11) NOT NULL, `value` mediumtext, PRIMARY KEY (`id`)', "ENGINE=$engine DEFAULT CHARSET=$charset");
