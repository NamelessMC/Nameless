...
class Queries {
    ...
    public function dbInitialise(string $charset = 'latin1', string $engine = 'InnoDB') {
        ...
        $this->_db->createTable('discord_verifications', '`id` int(11) NOT NULL AUTO_INCREMENT, `token` varchar(23) NOT NULL, `user_id` int(11) NOT NULL, PRIMARY KEY (`id`)', "ENGINE=$engine DEFAULT CHARSET=$charset");
