...
class Queries {
    ...
    public function dbInitialise($charset = 'latin1', $engine = 'InnoDB'){
        ...
        if(!empty($data)){
            ...
            $data = $this->_db->createTable('users_placeholders', ' `id` int(11) NOT NULL AUTO_INCREMENT, `server_id` int(4) NOT NULL, `uuid` varbinary(16) NOT NULL, `name` varchar(186) NOT NULL, `value` TEXT NOT NULL, `last_updated` int(11) NOT NULL', "ENGINE=$engine DEFAULT CHARSET=$charset");
