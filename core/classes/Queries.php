...
class Queries {
    ...
    public function dbInitialise($charset = 'latin1', $engine = 'InnoDB'){
        ...
        if(!empty($data)){
            ...
            $data = $this->_db->createTable('placeholders_settings', " `id` int(11) NOT NULL AUTO_INCREMENT, `server_id` int(11) NOT NULL, `name` varchar(256) NOT NULL, `friendly_name` varchar(256) NULL DEFAULT NULL, `show_on_profile` tinyint(1) NOT NULL DEFAULT '1', `show_on_forum` tinyint(1) NOT NULL DEFAULT '1', `leaderboard` tinyint(1) NOT NULL DEFAULT '0', `leaderboard_title` varchar(36) NULL DEFAULT NULL, `leaderboard_sort` varchar(4) NOT NULL DEFAULT 'DESC', PRIMARY KEY (`id`)", "ENGINE=$engine DEFAULT CHARSET=$charset");
            ...
            $data = $this->_db->createTable('users_placeholders', ' `id` int(11) NOT NULL AUTO_INCREMENT, `server_id` int(11) NOT NULL, `uuid` varchar(32) NOT NULL, `name` varchar(256) NOT NULL, `value` TEXT NOT NULL, `last_updated` int(11) NOT NULL, PRIMARY KEY (`id`)', "ENGINE=$engine DEFAULT CHARSET=$charset");
