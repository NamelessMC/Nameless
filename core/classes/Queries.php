...
class Queries {
	...
	public function dbInitialise($charset = 'latin1', $engine = 'InnoDB'){
		...
		if(!empty($data)){
			...
			$data = $this->_db->createTable("custom_announcements", " `id` int(11) NOT NULL AUTO_INCREMENT, `pages` varchar(128) NOT NULL, `groups` varchar(128) NOT NULL, `text_colour` varchar(7) NOT NULL, `background_colour` varchar(7) NOT NULL, `icon` varchar(64) NOT NULL, `closable` tinyint(1) NOT NULL DEFAULT '0', `header` varchar(64) NOT NULL, `message` varchar(255) NOT NULL, PRIMARY KEY (`id`)", "ENGINE=$engine DEFAULT CHARSET=$charset");
			...
			$data = $this->_db->createTable("hooks", " `id` int(11) NOT NULL AUTO_INCREMENT, `action` int(11) NOT NULL, `url` varchar(2048) NOT NULL, `events` varchar(2048) NOT NULL, PRIMARY KEY (`id`)", "ENGINE=$engine DEFAULT CHARSET=$charset");
