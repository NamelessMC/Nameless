...
foreach (['NAMELESS_SITE_NAME', 'NAMELESS_SITE_INCOMING_EMAIL', 'NAMELESS_SITE_OUTGOING_EMAIL', 'NAMELESS_ADMIN_EMAIL'] as $var) {
    getEnvVar($var);
}
...
$queries->create('settings', [
    'name' => 'incoming_email',
    'value' => getEnvVar('NAMELESS_SITE_INCOMING_EMAIL'),
]);
$queries->create('settings', [
    'name' => 'outgoing_email',
